...
THREE.Water = function ( geometry, options ) {
	...
	var normalSampler = options.normal !== undefined ? options.normal : null;
	...
	var mirrorShader = {
		...
		uniforms: THREE.UniformsUtils.merge( [
			...
			THREE.UniformsLib[ 'lights' ],
			{
				...
				time: { value: 0.0 },
				size: { value: options.size !== undefined ? options.size : 1.0 },
				distortionScale: { value: options.distortion !== undefined ? options.distortion : 20.0 },
				textureMatrix: { value: new THREE.Matrix4() },
				sunColor: { value: new THREE.Color( 0x7F7F7F ) },
				sunDirection: { value: new THREE.Vector3( 0.70707, 0.70707, 0 ) },
				eye: { value: new THREE.Vector3() },
				waterColor: { value: new THREE.Color( 0x555555 ) },
				depth: { value: options.depth !== undefined ? options.depth : 1.0 }
			}
		] ),
