...
SEA3D.Stream.prototype.readScriptList=function(a){for(var b=[],c=this.readUByte(),e=0;e<c;){var d=this.readUByte(),f={};f.priority=d&1|d&2;if(d&4){var q=this.readUByte();f.params={};for(var l=0;l<q;l++){var s=this.readUTF8Tiny();f.params[s]=this.readObject(a)}}d&8&&(f.method=this.readUTF8Tiny());f.tag=a.getObject(this.readUInt());b[e++]=f}return b};SEA3D.Stream.prototype.readObject=function(a){return this.readToken(this.readUByte(),a)};
...
SEA3D.Actions=function(a,b,c){this.name=a;this.data=b;this.sea3d=c;this.count=b.readUInt();this.actions=[];for(a=0;a<this.count;a++){var e=b.readUByte(),d=b.readUShort(),f=b.readUShort(),q=b.position,l=this.actions[a]={kind:d};e&1&&(l.range=[b.readUInt(),b.readUInt()]);e&2&&(l.time=b.readUInt());e&4&&(l.intrpl=b.readInterpolation(),0==l.intrpl.indexOf("back.")?l.intrplParam0=b.readFloat():0==l.intrpl.indexOf("elastic.")&&(l.intrplParam0=b.readFloat(),l.intrplParam1=b.readFloat()));switch(d){case SEA3D.Actions.RTT_TARGET:l.source=
c.getObject(b.readUInt());l.target=c.getObject(b.readUInt());break;case SEA3D.Actions.LOOK_AT:l.source=c.getObject(b.readUInt());l.target=c.getObject(b.readUInt());break;case SEA3D.Actions.PLAY_SOUND:l.sound=c.getObject(b.readUInt());l.offset=b.readUInt();break;case SEA3D.Actions.PLAY_ANIMATION:l.object=c.getObject(b.readUInt());l.name=b.readUTF8Tiny();break;case SEA3D.Actions.FOG:l.color=b.readUInt24();l.min=b.readFloat();l.max=b.readFloat();break;case SEA3D.Actions.ENVIRONMENT:l.texture=c.getObject(b.readUInt());
break;case SEA3D.Actions.ENVIRONMENT_COLOR:l.color=b.readUInt24F();break;case SEA3D.Actions.CAMERA:l.camera=c.getObject(b.readUInt());break;case SEA3D.Actions.SCRIPTS:l.scripts=b.readScriptList(c);break;case SEA3D.Actions.CLASS_OF:l.classof=c.getObject(b.readUInt());break;case SEA3D.Actions.ATTRIBUTES:l.attributes=c.getObject(b.readUInt());break;default:console.log('Action "'+d+'" not found.')}b.position=q+f}};SEA3D.Actions.SCENE=0;SEA3D.Actions.ENVIRONMENT_COLOR=1;SEA3D.Actions.ENVIRONMENT=2;
...
SEA3D.Morph=function(a,b,c){SEA3D.GeometryBase.call(this,a,b,c);a=0!=(this.attrib&2);c=0!=(this.attrib&4);var e=b.readUShort();this.node=[];for(var d=0;d<e;d++){var f=b.readUTF8Tiny(),q,l;a&&(q=b.readFloatArray(this.length));c&&(l=b.readFloatArray(this.length));this.node[d]={vertex:q,normal:l,name:f}}};SEA3D.Morph.prototype=Object.create(SEA3D.GeometryBase.prototype);SEA3D.Morph.prototype.constructor=SEA3D.Morph;SEA3D.Morph.prototype.type="mph";
...
this.depthWrite=0==(this.attrib&256);this.depthTest=0==(this.attrib&512);this.premultipliedAlpha=0!=(this.attrib&1024);a=b.readUByte();for(var e=0;e<a;++e){var d=b.readUShort(),f=b.readUShort(),q=b.position,l,s;switch(d){case SEA3D.Material.PHONG:l={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.PHYSICAL:l={color:b.readUInt24(),roughness:b.readFloat(),metalness:b.readFloat()};break;case SEA3D.Material.ANISOTROPIC:break;
case SEA3D.Material.COMPOSITE_TEXTURE:l={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:case SEA3D.Material.SPECULAR_MAP:case SEA3D.Material.NORMAL_MAP:case SEA3D.Material.AMBIENT_MAP:case SEA3D.Material.ALPHA_MAP:case SEA3D.Material.EMISSIVE_MAP:case SEA3D.Material.ROUGHNESS_MAP:case SEA3D.Material.METALNESS_MAP:l={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:l={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};
d==SEA3D.Material.FRESNEL_REFLECTION&&(l.power=b.readFloat(),l.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:l={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:l={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:l={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:l={texture:c.getObject(b.readUInt()),
scale:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.CEL:l={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:l={translucency:b.readFloat(),scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:s=b.readUByte();l={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};s&1?(l.offsetX0=b.readFloat(),l.offsetY0=b.readFloat(),l.offsetX1=b.readFloat(),
l.offsetY1=b.readFloat()):l.offsetX0=l.offsetY0=l.offsetX1=l.offsetY1=0;l.animate=s&2;break;case SEA3D.Material.MIRROR_REFLECTION:l={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.EMISSIVE:l={color:b.readUInt24F()};break;case SEA3D.Material.VERTEX_COLOR:l={blendMode:b.readBlendMode()};break;case SEA3D.Material.WRAP_LIGHTING:l={color:b.readUInt24(),strength:b.readFloat()};break;case SEA3D.Material.COLOR_REPLACE:s=b.readUByte();l={red:b.readUInt24(),green:b.readUInt24(),
blue:b.readUInt24F()};s&1&&(l.mask=c.getObject(b.readUInt()));s&2&&(l.alpha=b.readFloat());break;case SEA3D.Material.REFLECTION_SPHERICAL:l={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;case SEA3D.Material.REFLECTIVITY:s=b.readUByte();l={strength:b.readFloat()};s&1&&(l.mask=c.getObject(b.readUInt()));break;case SEA3D.Material.CLEAR_COAT:l={strength:b.readFloat(),roughness:b.readFloat()};break;case SEA3D.Material.FLACCIDITY:s=b.readUByte();l={target:c.getObject(b.readUInt()),scale:b.readFloat(),
spring:b.readFloat(),damping:b.readFloat()};s&1&&(l.mask=c.getObject(b.readUInt()));break;default:console.warn("SEA3D: MaterialTechnique not found:",d.toString(16));b.position=q+f;continue}l.kind=d;this.technique.push(l);this.tecniquesDict[d]=l;b.position=q+f}};SEA3D.Material.PHONG=0;SEA3D.Material.COMPOSITE_TEXTURE=1;SEA3D.Material.DIFFUSE_MAP=2;SEA3D.Material.SPECULAR_MAP=3;SEA3D.Material.REFLECTION=4;SEA3D.Material.REFRACTION=5;SEA3D.Material.NORMAL_MAP=6;SEA3D.Material.FRESNEL_REFLECTION=7;
...
SEA3D.File.prototype.load=function(a){var b=this,c=new XMLHttpRequest;c.open("GET",a,!0);this.config.path||(this.config.path=SEA3D.extractUrlBase(a));if(b.config.progressive){var e=0;c.overrideMimeType("text/plain; charset=x-user-defined")}else c.responseType="arraybuffer";c.onprogress=function(a){if(b.config.progressive){for(var f=c.responseText.substring(e),q=new Uint8Array(f.length),l=0;l<f.length;l++)q[l]=f.charCodeAt(l)&255;e+=f.length;b.append(q.buffer)}b.dispatchDownloadProgress(a.loaded,a.total)};
...
this._rangeDecoder.init()};a.Decoder.prototype.decode=function(b,c,e){var d=0,f=0,q=0,l=0,s=0,u=0,n=0;this._rangeDecoder.setStream(b);this._outWindow.setStream(c);for(this.init();0>e||u<e;)if(b=u&this._posStateMask,0===this._rangeDecoder.decodeBit(this._isMatchDecoders,(d<<4)+b))n=this._literalDecoder.getDecoder(u++,n),n=7<=d?n.decodeWithMatchByte(this._rangeDecoder,this._outWindow.getByte(f)):n.decodeNormal(this._rangeDecoder),this._outWindow.putByte(n),d=4>d?0:d-(10>d?3:6);else{if(1===this._rangeDecoder.decodeBit(this._isRepDecoders,
d))n=0,0===this._rangeDecoder.decodeBit(this._isRepG0Decoders,d)?0===this._rangeDecoder.decodeBit(this._isRep0LongDecoders,(d<<4)+b)&&(d=7>d?9:11,n=1):(0===this._rangeDecoder.decodeBit(this._isRepG1Decoders,d)?c=q:(0===this._rangeDecoder.decodeBit(this._isRepG2Decoders,d)?c=l:(c=s,s=l),l=q),q=f,f=c),0===n&&(n=2+this._repLenDecoder.decode(this._rangeDecoder,b),d=7>d?8:11);else if(s=l,l=q,q=f,n=2+this._lenDecoder.decode(this._rangeDecoder,b),d=7>d?7:10,b=this._posSlotDecoder[5>=n?n-2:3].decode(this._rangeDecoder),
4<=b)if(c=(b>>1)-1,f=(2|b&1)<<c,14>b)f+=a.reverseDecode2(this._posDecoders,f-b-1,this._rangeDecoder,c);else{if(f+=this._rangeDecoder.decodeDirectBits(c-4)<<4,f+=this._posAlignDecoder.reverseDecode(this._rangeDecoder),0>f){if(-1===f)break;return!1}}else f=b;if(f>=u||f>=this._dictionarySizeCheck)return!1;this._outWindow.copyBlock(f,n);u+=n;n=this._outWindow.getByte(0)}this._outWindow.flush();this._outWindow.releaseStream();this._rangeDecoder.releaseStream();return!0};a.Decoder.prototype.setDecoderProperties=
...
THREE.SEA3D.prototype.addDefaultAnimation=function(a,b){for(var c=a.tag,e=0,d=a.animations?a.animations.length:0;e<d;e++){var f=a.animations[e];switch(f.tag.type){case SEA3D.Animation.prototype.type:return e=f.tag.tag||this.getModifier({sea:f.tag,scope:c,relative:f.relative}),c.animator=new b(e,c),c.animator.setRelative(f.relative),this.config.autoPlay&&c.animator.play(0),c.animator}}};
THREE.SEA3D.prototype.readGeometryBuffer=function(a){for(var b=a.tag||new THREE.BufferGeometry,c=0;c<a.groups.length;c++){var e=a.groups[c];b.addGroup(e.start,e.count,c)}a.indexes&&b.setIndex(new THREE.BufferAttribute(a.indexes,1));b.setAttribute("position",new THREE.BufferAttribute(a.vertex,3));a.uv&&(b.setAttribute("uv",new THREE.BufferAttribute(a.uv[0],2)),1<a.uv.length&&b.setAttribute("uv2",new THREE.BufferAttribute(a.uv[1],2)));a.normal?b.setAttribute("normal",new THREE.BufferAttribute(a.normal,
3)):b.computeVertexNormals();a.tangent4&&b.setAttribute("tangent",new THREE.BufferAttribute(a.tangent4,4));a.color&&b.setAttribute("color",new THREE.BufferAttribute(a.color[0],a.numColor));a.joint&&(b.setAttribute("skinIndex",new THREE.Float32BufferAttribute(a.joint,a.jointPerVertex)),b.setAttribute("skinWeight",new THREE.Float32BufferAttribute(a.weight,a.jointPerVertex)));this.config.bounding&&(b.computeBoundingBox(),b.computeBoundingSphere());b.name=a.name;this.domain.geometries=this.geometries=
...
THREE.SEA3D.prototype.readLine=function(a){var b=new THREE.BufferGeometry;a.closed&&a.vertex.push(a.vertex[0],a.vertex[1],a.vertex[2]);b.setAttribute("position",new THREE.Float32BufferAttribute(a.vertex,3));b=new THREE.Line(b,new THREE.LineBasicMaterial({color:THREE.SEA3D.HELPER_COLOR,linewidth:3}));b.name=a.name;this.lines=this.lines||[];this.lines.push(this.objects["line/"+a.name]=a.tag=b);this.addSceneObject(a);this.updateTransform(b,a);this.addDefaultAnimation(a,THREE.SEA3D.Object3DAnimator)};
...
THREE.SEA3D.prototype.readMesh=function(a){var b,c,e=a.geometry.tag,d,f,q,l,s,u,n;b=0;for(c=a.modifiers?a.modifiers.length:0;b<c;b++){var h=a.modifiers[b];switch(h.type){case SEA3D.Skeleton.prototype.type:case SEA3D.SkeletonLocal.prototype.type:f=h;e.bones=f.tag;break;case SEA3D.Morph.prototype.type:q=h.tag||this.getModifier({sea:h,geometry:a.geometry}),e.morphAttributes=q.attribs,e.morphTargets=q.targets}}b=0;for(c=a.animations?a.animations.length:0;b<c;b++)switch(h=a.animations[b].tag,h.type){case SEA3D.SkeletonAnimation.prototype.type:l=
h;e.animations=l.tag||this.getModifier({sea:l,skeleton:f,relative:!0});break;case SEA3D.VertexAnimation.prototype.type:s=h;e.morphAttributes=s.tag.attribs;e.morphTargets=s.tag.targets;e.animations=s.tag.animations;break;case SEA3D.UVWAnimation.prototype.type:u=h.tag||this.getModifier({sea:h});break;case SEA3D.MorphAnimation.prototype.type:n=h.tag||this.getModifier({sea:h})}c=void 0!=q||void 0!=s;q=q&&void 0!=q.attribs.normal||s&&void 0!=s.tag.attribs.normal;if(a.material)if(1<a.material.length){d=
[];for(b=0;b<a.material.length;b++)d[b]=a.material[b].tag,d[b].skinning=void 0!=f,d[b].morphTargets=c,d[b].morphNormals=q,d[b].vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;d=THREE.SEA3D.useMultiMaterial?new THREE.MultiMaterial(d):d}else d=a.material[0].tag,d.skinning=void 0!=f,d.morphTargets=c,d.morphNormals=q,d.vertexColors=a.geometry.color?THREE.VertexColors:THREE.NoColors;f?(b=new THREE.SEA3D.SkinnedMesh(e,d,this.config.useVertexTexture),this.config.autoPlay&&l&&b.play(0)):s?
(b=new THREE.SEA3D.VertexAnimationMesh(e,d),this.config.autoPlay&&b.play(0)):b=new THREE.SEA3D.Mesh(e,d);u&&(b.uvwAnimator=new THREE.SEA3D.Animator(u,new THREE.AnimationMixer(d.map)),this.config.autoPlay&&b.uvwAnimator.play(0));n&&(b.morphAnimator=new THREE.SEA3D.Animator(n,new THREE.AnimationMixer(b)),this.config.autoPlay&&b.morphAnimator.play(0));b.name=a.name;b.castShadow=a.castShadows;b.receiveShadow=a.material?a.material[0].receiveShadows:!0;this.domain.meshes=this.meshes=this.meshes||[];this.meshes.push(this.objects["m3d/"+
...
THREE.SEA3D.prototype.readMorph=function(a){for(var b={position:[]},c=[],e=0;e<a.node.length;e++){var d=a.node[e];b.position[e]=new THREE.Float32BufferAttribute(d.vertex,3);b.position[e].name=d.name;d.normal&&(b.normal=b.normal||[],b.normal[e]=new THREE.Float32BufferAttribute(d.normal,3));c[e]={name:d.name}}a.tag={attribs:b,targets:c}};
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var d=a.sequence[e],f=[],q=0;q<a.dataList.length;q++){var l=a.dataList[q],s,u,n,h=l.data;n=d.start*l.blockSize;s=n+d.count*l.blockSize;var p=d.intrpl?THREE.InterpolateLinear:!1,r=null;switch(l.kind){case SEA3D.Animation.POSITION:r=".position";break;case SEA3D.Animation.ROTATION:r=".quaternion";break;case SEA3D.Animation.SCALE:r=".scale";break;case SEA3D.Animation.COLOR:r=".color";break;
...
h.subarray(n,s);u=new Float32Array(n.length);for(s=l=0;s<u.length;s++)u[s]=l,l+=c;f.push(new THREE.NumberKeyframeTrack(r,u,n,p));break;case SEA3D.Stream.VECTOR3D:n=h.subarray(n,s);u=new Float32Array(n.length/l.blockSize);for(s=l=0;s<u.length;s++)u[s]=l,l+=c;f.push(new THREE.VectorKeyframeTrack(r,u,n,p));break;case SEA3D.Stream.VECTOR4D:n=h.subarray(n,s);u=new Float32Array(n.length/l.blockSize);for(s=l=0;s<u.length;s++)u[s]=l,l+=c;f.push(new THREE.QuaternionKeyframeTrack(r,u,n,p));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:n=
new Float32Array(3*(s-n));u=new Float32Array(n.length/3);for(s=l=0;s<u.length;s++)n[3*s]=(h[s]>>16&255)/255,n[3*s+1]=(h[s]>>8&255)/255,n[3*s+2]=(h[s]&255)/255,u[s]=l,l+=c;f.push(new THREE.VectorKeyframeTrack(r,u,n,p))}}b.push(new THREE.SEA3D.AnimationClip(d.name,-1,f,d.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".anm"]=a.tag=b)};
THREE.SEA3D.prototype.readSkeletonAnimation=function(a,b){b=!b&&a.metadata&&a.metadata.skeleton?a.metadata.skeleton:b;if(!b||a.tag)return a.tag;for(var c=[],e=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++){for(var f=a.sequence[d],q=f.start,l=q+f.count,s={name:f.name,fps:a.frameRate,length:e*f.count,hierarchy:[]},u=a.numJoints,n=a.raw,h=0;h<u;h++){for(var p={parent:b.joint[h].parentIndex,keys:[]},r=p.keys,g=0,k=q;k<l;k++){var m=k*u*7+7*h;r.push({time:g,pos:[n[m],n[m+1],n[m+2]],rot:[n[m+3],n[m+4],
n[m+5],n[m+6]],scl:[1,1,1]});g+=e}s.hierarchy[h]=p}c.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(s,b.tag),f.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".skla"]=a.tag=c)};
THREE.SEA3D.prototype.readVertexAnimation=function(a){var b={position:[]},c=[],e=[],d,f;d=0;for(f=a.frame.length;d<f;d++){var q=a.frame[d];b.position[d]=new THREE.Float32BufferAttribute(q.vertex,3);q.normal&&(b.normal=b.normal||[],b.normal[d]=new THREE.Float32BufferAttribute(q.normal,3));c[d]={name:d}}for(d=0;d<a.sequence.length;d++){var q=a.sequence[d],l=[];for(f=0;f<q.count;f++)l[f]=c[q.start+f];e.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.CreateFromMorphTargetSequence(q.name,l,
a.frameRate),q.repeat))}a.tag={attribs:b,targets:c,animations:e};this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[a.name+".vtxa"]=a.tag)};
...
THREE.SEA3D.prototype.flipDefaultAnimation=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Vector3,e=new THREE.Quaternion,d=new THREE.Vector3,f=new THREE.Vector3,q=new THREE.Quaternion,l=new THREE.Vector3;return function(s,u,n){if(!s.isFliped){for(var h=s.dataList,p=[],r=0;r<h.length;r++){var g=h[r],k=g.data,m=g.kind,g=k.length/g.blockSize;switch(m){case SEA3D.Animation.POSITION:case SEA3D.Animation.ROTATION:case SEA3D.Animation.SCALE:p.push({kind:m,numFrames:g,raw:k})}}if(0<p.length)for(g=
p[0].numFrames,k=void 0,n?(a.identity(),this.flipScaleMatrix(b.copy(u.matrixWorld))):(u.parent&&(k=this.flipScaleMatrix(b.copy(u.parent.matrixWorld))),this.flipScaleMatrix(a.copy(u.matrix),!1,k)),a.decompose(c,e,d),u=0;u<g;u++){for(n=0;n<p.length;n++)switch(k=p[n].raw,m=p[n].kind,m){case SEA3D.Animation.POSITION:m=3*u;c.set(k[m],k[m+1],k[m+2]);break;case SEA3D.Animation.ROTATION:m=4*u;e.set(k[m],k[m+1],k[m+2],k[m+3]);break;case SEA3D.Animation.SCALE:m=4*u,d.set(k[m],k[m+1],k[m+2])}a.compose(c,e,d);
this.flipScaleMatrix(a,!1,b);a.decompose(f,q,l);for(n=0;n<p.length;n++)switch(k=p[n].raw,m=p[n].kind,m){case SEA3D.Animation.POSITION:m=3*u;k[m]=f.x;k[m+1]=f.y;k[m+2]=f.z;break;case SEA3D.Animation.ROTATION:m=4*u;k[m]=q.x;k[m+1]=q.y;k[m+2]=q.z;k[m+3]=q.w;break;case SEA3D.Animation.SCALE:m=3*u,k[m]=l.x,k[m+1]=l.y,k[m+2]=l.z}}s.isFliped=!0}}}();THREE.SEA3D.prototype.readAnimation=function(a){this.isLegacy(a)||this._readAnimation(a)};
...
THREE.SEA3D.prototype.readSkeleton=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Matrix4,e=new THREE.Vector3,d=new THREE.Quaternion;return function(f){for(var q=[],l=f.sea3d.config.legacy,s=0;s<f.joint.length;s++){var u=f.joint[s];a.fromArray(u.inverseBindMatrix);b.getInverse(a);l&&this.flipBoneMatrix(b);-1<u.parentIndex&&(a.fromArray(f.joint[u.parentIndex].inverseBindMatrix),c.getInverse(a),l&&this.flipBoneMatrix(c),c.getInverse(c),b.multiplyMatrices(c,b));e.setFromMatrixPosition(b);
...
THREE.SEA3D.prototype.readSkeletonAnimationLegacy=function(){var a=new THREE.Matrix4,b=new THREE.Matrix4,c=new THREE.Matrix4,e=new THREE.Matrix4;return function(d,f){if(d.tag)return d.tag;for(var q=[],l=1E3/d.frameRate/1E3,s=[1,1,1],u=0;u<d.sequence.length;u++){for(var n=d.sequence[u],h=n.start,p=h+n.count,r={name:n.name,repeat:n.repeat,fps:d.frameRate,JIT:0,length:l*n.count,hierarchy:[]},g=d.numJoints,k=d.raw,m=0;m<g;m++){for(var w=f.joint[m],t={parent:w.parentIndex,keys:[]},y=t.keys,v=0,A=h;A<p;A++){var x=
A*g*7+7*m;b.makeRotationFromQuaternion(THREE.SEA3D.QUABUF.set(k[x+3],k[x+4],k[x+5],k[x+6]));b.setPosition(THREE.SEA3D.VECBUF.set(k[x],k[x+1],k[x+2]));-1<w.parentIndex?(a.fromArray(f.joint[w.parentIndex].inverseBindMatrix),e.getInverse(a),c.multiplyMatrices(e,b),this.flipBoneMatrix(c),this.flipBoneMatrix(e),e.getInverse(e),b.multiplyMatrices(e,c)):this.flipBoneMatrix(b);var x=THREE.SEA3D.VECBUF.setFromMatrixPosition(b),B=THREE.SEA3D.QUABUF.setFromRotationMatrix(b);y.push({time:v,pos:[x.x,x.y,x.z],
rot:[B.x,B.y,B.z,B.w],scl:s});v+=l}r.hierarchy[m]=t}q.push(THREE.SEA3D.AnimationClip.fromClip(THREE.AnimationClip.parseAnimation(r,f.tag),n.repeat))}this.domain.clips=this.clips=this.clips||[];this.clips.push(this.objects[d.name+".anm"]=d.tag=q)}}();THREE.SEA3D.prototype.readMorphLegacy=function(a,b){for(var c=0;c<a.node.length;c++){var e=a.node[c];this.flipVec3(e.vertex);this.flipVec3(e.normal);this.addVector(e.vertex,b.vertex);this.addVector(e.normal,b.normal)}this._readMorph(a)};
THREE.SEA3D.prototype.readMorph=function(a){this.isLegacy(a)||this._readMorph(a)};THREE.SEA3D.prototype.readVertexAnimation=function(a){if(this.isLegacy(a))for(var b=0,c=a.frame.length;b<c;b++){var e=a.frame[b];this.flipVec3(e.vertex);this.flipVec3(e.normal)}this._readVertexAnimation(a)};
...
THREE.SEA3D.EXTENSIONS_LOADER.push({setTypeRead:function(){this.config.legacy=void 0==this.config.legacy?!0:this.config.legacy;this.file.typeRead[SEA3D.Skeleton.prototype.type]=this.readSkeleton}});var o3dgc=function(){function a(a,b,c,d){var e,h,p,r;e=-1;h=!1;r=b.m_value;for(p=0;p<r;++p)if(a.Equal(c[p].m_id)){h=!0;break}else if(a.Less(c[p].m_id)){b.m_value<f.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS&&++b.m_value;for(e=b.m_value-1;e>p;--e)for(c[e].m_id.m_a=c[e-1].m_id.m_a,c[e].m_id.m_b=c[e-1].m_id.m_b,c[e].m_id.m_c=c[e-1].m_id.m_c,h=0;h<d;++h)c[e].m_pred[h]=c[e-1].m_pred[h];c[p].m_id.m_a=a.m_a;c[p].m_id.m_b=a.m_b;c[p].m_id.m_c=a.m_c;e=p;h=!0;break}!h&&b.m_value<f.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS&&
(e=b.m_value++,c[e].m_id.m_a=a.m_a,c[e].m_id.m_b=a.m_b,c[e].m_id.m_c=a.m_c);return e}function b(a){return a&1?-(a+1>>>1):a>>>1}function c(b,c,s,e,n,f,p,r){var g,k,m,w,t;t=new d.SC3DMCTriplet(-1,-1,-1);for(k=0;3>k;++k)if(g=b[3*c+k],g<s&&(t.m_a=-1,t.m_b=-1,t.m_c=g,m=a(t,e,n,f),-1!==m))for(g*=r,w=0;w<f;++w)n[m].m_pred[w]=p[g+w]}function e(b,c,s,e,f,h,p,r,g,k){var m,w,t,y,v,A,x,B;m=3*c;B=new d.SC3DMCTriplet(-1,-1,-1);b[m]===s?(c=b[m+1],m=b[m+2]):b[m+1]===s?(c=b[m],m=b[m+2]):(c=b[m],m=b[m+1]);if(c<s&&
m<s)for(x=g.Begin(c),g=g.End(c);x<g;++x){y=k[x];if(0>y)break;w=3*y;y=-1;v=!1;for(A=0;3>A;++A)t=b[w+A],t===m?v=!0:t<s&&t!==c&&(y=t);if(-1!==y&&v&&(c<m?(B.m_a=c,B.m_b=m):(B.m_a=m,B.m_b=c),B.m_c=-y-1,A=a(B,e,f,h),-1!==A))for(w=c*r,t=m*r,y*=r,v=0;v<h;++v)f[A].m_pred[v]=p[w+v]+p[t+v]-p[y+v]}}var d,f;d={};f={O3DGC_BINARY_STREAM_BITS_PER_SYMBOL0:7,O3DGC_BINARY_STREAM_MAX_SYMBOL0:127,O3DGC_BINARY_STREAM_BITS_PER_SYMBOL1:6,O3DGC_BINARY_STREAM_MAX_SYMBOL1:63,O3DGC_BINARY_STREAM_NUM_SYMBOLS_UINT32:5,O3DGC_BIG_ENDIAN:0,
...
d.ArithmeticDecoder.prototype.DecodeAdaptiveDataModel=function(a){var b,c,d,e,h,p;e=this.m_length;if(0<a.m_tableSize){d=Math.floor(this.m_value/(this.m_length>>>=f.O3DGC_AC_DM_LENGTH_SHIFT));b=d>>>a.m_tableShift;c=a.m_decoderTable[b];for(b=a.m_decoderTable[b+1]+1;b>c+1;)p=c+b>>>1,a.m_distribution[p]>d?b=p:c=p;d=a.m_distribution[c]*this.m_length;c!==a.m_lastSymbol&&(e=a.m_distribution[c+1]*this.m_length)}else{d=c=0;this.m_length>>>=f.O3DGC_AC_DM_LENGTH_SHIFT;p=(b=a.m_dataSymbols)>>>1;do h=this.m_length*
a.m_distribution[p],h>this.m_value?(b=p,e=h):(c=p,d=h);while((p=c+b>>>1)!==c)}this.m_value-=d;this.m_length=e-d;this.m_length<f.O3DGC_AC_MIN_LENGTH&&this.RenormDecInterval();++a.m_symbolCount[c];0===--a.m_symbolsUntilUpdate&&a.Update(!1);return c};d.ArithmeticDecoder.prototype.ExpGolombDecode=function(a,b,c){var d,e,f;e=d=0;do if(f=this.DecodeAdaptiveBitModel(c))d+=1<<a>>>0,a++;while(f);for(;a--;)this.DecodeStaticBitModel(b)&&(e=(e|1<<a)>>>0);return d+e};d.ArithmeticDecoder.prototype.RenormDecInterval=
...
function(a,b,c){var e,n,h,p;b.ReadUInt32ASCII(c);e=b.ReadUInt32ASCII(c);a.Allocate(e*f.O3DGC_BINARY_STREAM_BITS_PER_SYMBOL0);a.Clear();for(h=0;h<e;)for(n=b.ReadUCharASCII(c),p=0;p<f.O3DGC_BINARY_STREAM_BITS_PER_SYMBOL0;++p)a.PushBack(n&1),n>>>=1,++h;return d.O3DGC_OK};d.CompressedTriangleFans.prototype.LoadUIntAC=function(a,b,c,e){var f,h,p;f=c.ReadUInt32Bin(e)-12;h=c.ReadUInt32Bin(e);if(0===h)return d.O3DGC_OK;p=c.ReadUInt32Bin(e);c=c.GetBuffer(e,f);e.m_count+=f;a.Allocate(h);e=new d.ArithmeticDecoder;
e.SetBuffer(f,c);e.StartDecoder();f=new d.AdaptiveDataModel;f.SetAlphabet(b+1);for(b=0;b<h;++b)a.PushBack(e.DecodeAdaptiveDataModel(f)+p);return d.O3DGC_OK};d.CompressedTriangleFans.prototype.LoadIntACEGC=function(a,b,c,e){var n,h,p,r,g,k;n=c.ReadUInt32Bin(e)-12;h=c.ReadUInt32Bin(e);if(0===h)return d.O3DGC_OK;p=c.ReadUInt32Bin(e)-f.O3DGC_MAX_LONG;c=c.GetBuffer(e,n);e.m_count+=n;a.Allocate(h);e=new d.ArithmeticDecoder;e.SetBuffer(n,c);e.StartDecoder();n=new d.AdaptiveDataModel;n.SetAlphabet(b+2);c=
new d.StaticBitModel;r=new d.AdaptiveBitModel;for(k=0;k<h;++k)g=e.DecodeAdaptiveDataModel(n),g===b&&(g+=e.ExpGolombDecode(0,c,r)),a.PushBack(g+p);return d.O3DGC_OK};d.CompressedTriangleFans.prototype.LoadBinAC=function(a,b,c){var e,f;e=b.ReadUInt32Bin(c)-8;f=b.ReadUInt32Bin(c);if(0===f)return d.O3DGC_OK;b=b.GetBuffer(c,e);c.m_count+=e;a.Allocate(f);c=new d.ArithmeticDecoder;c.SetBuffer(e,b);c.StartDecoder();e=new d.AdaptiveBitModel;for(b=0;b<f;++b)a.PushBack(c.DecodeAdaptiveBitModel(e));return d.O3DGC_OK};
...
function(){return this.m_streamType};d.TriangleListDecoder.prototype.GetReorderTriangles=function(){return this.m_decodeTrianglesOrder};d.TriangleListDecoder.prototype.GetReorderVertices=function(){return this.m_decodeVerticesOrder};d.TriangleListDecoder.prototype.SetStreamType=function(a){this.m_streamType=a};d.TriangleListDecoder.prototype.GetVertexToTriangle=function(){return this.m_vertexToTriangle};d.TriangleListDecoder.prototype.Reorder=function(){var a,c,e,f,n,h,p;if(this.m_decodeTrianglesOrder)for(a=
this.m_triangles,c=this.m_numTriangles,e=this.m_ctfans.m_trianglesOrder.m_data,h=this.m_tempTriangles,h.set(a),p=n=f=0;p<c;++p)n=b(e[f++])+n,a[3*n]=h[3*p],a[3*n+1]=h[3*p+1],a[3*n+2]=h[3*p+2],n+=1;return d.O3DGC_OK};d.TriangleListDecoder.prototype.CompueLocalConnectivityInfo=function(a){var b,c,e,f,h,p,r,g,k,m,w,t,y,v;b=this.m_visitedVertices;c=this.m_visitedVerticesValence;e=this.m_triangles;f=this.m_vertexToTriangle;h=f.Begin(a);p=f.End(a);for(t=k=r=0;0<=t&&h<p;++h)if(t=f.GetNeighbor(h),0<=t)for(++r,
y=3*t,w=0;3>w;++w)if(v=e[y+w],v>a){g=!1;for(m=0;m<k;++m)if(v===b[m]){c[m]++;g=!0;break}else if(v<b[m]){++k;for(g=k-1;g>m;--g)b[g]=b[g-1],c[g]=c[g-1];b[m]=v;c[m]=1;g=!0;break}g||(b[k]=v,c[k]=1,k++)}if(2<k)for(e=1;e<k;++e)if(1===c[e])for(f=e;0<f&&c[f]<c[f-1];)a=c[f],c[f]=c[f-1],c[f-1]=a,a=b[f],b[f]=b[f-1],b[f-1]=a,--f;this.m_numConqueredTriangles=r;this.m_numVisitedVertices=k;return d.O3DGC_OK};d.TriangleListDecoder.prototype.DecompressTFAN=function(a){var b,c,e,f,h,p,r,g,k,m,w,t,y,v,A,x;b=this.m_vertexToTriangle;
c=this.m_triangles;e=this.m_itDegree;f=this.m_itConfig;h=this.m_tfans;r=this.m_processConfig;g=this.m_ctfans;k=this.m_triangleCount;m=this.m_numConqueredTriangles;p=g.ReadNumTFans(this.m_itNumTFans);if(0<p)for(A=0;A<p;++A)for(h.AddTFAN(),w=g.ReadDegree(e)+2-m,t=g.ReadConfig(f),y=h.GetNumVertices(),h.AddVertex(a),r[t](this,w,a),w=h.GetNumVertices(),t=h.GetVertex(y+1),x=y+2;x<w;++x)y=h.GetVertex(x),v=3*k,c[v++]=a,c[v++]=t,c[v]=y,b.AddNeighbor(a,k),b.AddNeighbor(t,k),b.AddNeighbor(y,k),t=y,k++;this.m_triangleCount=
k;return d.O3DGC_OK};d.TriangleListDecoder.prototype.Decompress=function(){var a;for(a=0;a<this.m_numVertices;++a)a===this.m_vertexCount&&this.m_vertexCount++,this.CompueLocalConnectivityInfo(a),this.DecompressTFAN(a);return d.O3DGC_OK};d.TriangleListDecoder.prototype.Init=function(a,b,c,e){this.m_numTriangles=b;this.m_numVertices=c;this.m_triangles=a;this.m_triangleCount=this.m_vertexCount=0;this.m_itNumTFans.m_count=0;this.m_itDegree.m_count=0;this.m_itConfig.m_count=0;this.m_itOperation.m_count=
...
b.ReadFloat32(this.m_iterator,this.m_streamType));a.SetNormalPerVertex(1===b.ReadUChar(this.m_iterator,this.m_streamType));this.m_params.SetNormalQuantBits(b.ReadUChar(this.m_iterator,this.m_streamType))}for(e=0;e<a.GetNumFloatAttributes();++e)if(a.SetNFloatAttribute(e,b.ReadUInt32(this.m_iterator,this.m_streamType)),0<a.GetNFloatAttribute(e)){a.SetNFloatAttributeIndex(e,b.ReadUInt32(this.m_iterator,this.m_streamType));n=b.ReadUChar(this.m_iterator,this.m_streamType);a.SetFloatAttributeDim(e,n);for(c=
0;c<n;++c)a.SetFloatAttributeMin(e,c,b.ReadFloat32(this.m_iterator,this.m_streamType)),a.SetFloatAttributeMax(e,c,b.ReadFloat32(this.m_iterator,this.m_streamType));a.SetFloatAttributePerVertex(e,1===b.ReadUChar(this.m_iterator,this.m_streamType));a.SetFloatAttributeType(e,b.ReadUChar(this.m_iterator,this.m_streamType));this.m_params.SetFloatAttributeQuantBits(e,b.ReadUChar(this.m_iterator,this.m_streamType))}for(e=0;e<a.GetNumIntAttributes();++e)a.SetNIntAttribute(e,b.ReadUInt32(this.m_iterator,this.m_streamType)),
0<a.GetNIntAttribute(e)&&(a.SetNIntAttributeIndex(e,b.ReadUInt32(this.m_iterator,this.m_streamType)),a.SetIntAttributeDim(e,b.ReadUChar(this.m_iterator,this.m_streamType)),a.SetIntAttributePerVertex(e,1===b.ReadUChar(this.m_iterator,this.m_streamType)),a.SetIntAttributeType(e,b.ReadUChar(this.m_iterator,this.m_streamType)));return d.O3DGC_OK};d.SC3DMCDecoder.prototype.DecodeIntArrayBinary=function(a,b,e,u,n,h,p){var r,g,k,m,w,t,y,v,A,x,B,E,G,D,z,C,F;m=this.m_iterator;w=this.m_streamType;t=new d.ArithmeticDecoder;
y=new d.StaticBitModel;v=new d.AdaptiveBitModel;A=new d.AdaptiveDataModel;A.SetAlphabet(f.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS+1);x=this.m_triangleListDecoder.GetVertexToTriangle();B=x.m_neighbors;n=n.GetCoordIndex();E=m.m_count;G=p.ReadUInt32(m,w);D=p.ReadUChar(m,w);w=D>>>4&7;h.m_value=D&7;G-=m.m_count-E;E=new d.Iterator;E.m_count=m.m_count+G;new d.SC3DMCTriplet(-1,-1,-1);if(w!==f.O3DGC_SC3DMC_BINARIZATION_AC_EGC)return d.O3DGC_ERROR_CORRUPTED_STREAM;p=p.GetBuffer(m,G);m.m_count+=G;t.SetBuffer(G,
p);t.StartDecoder();G=t.ExpGolombDecode(0,y,v);w=t.ExpGolombDecode(0,y,v);D=new d.AdaptiveDataModel;D.SetAlphabet(w+2);z=this.m_neighbors;C=new d.NumberRef;p=h.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION;for(F=0;F<b;++F){C.m_value=0;if(0<x.GetNumNeighbors(F)&&p)for(g=x.Begin(F),r=x.End(F);g<r;++g){k=B[g];if(0>k)break;c(n,k,F,C,z,e,a,u)}if(1<C.m_value)for(r=t.DecodeAdaptiveDataModel(A),g=0;g<e;++g)k=t.DecodeIntACEGC(D,y,v,G,w),a[F*u+g]=k+z[r].m_pred[g];else if(0<F&&h.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION)for(g=
0;g<e;++g)k=t.DecodeIntACEGC(D,y,v,G,w),a[F*u+g]=k+a[(F-1)*u+g];else for(g=0;g<e;++g)k=t.DecodeUIntACEGC(D,y,v,G,w),a[F*u+g]=k}m.m_count=E.m_count;return d.O3DGC_OK};d.SC3DMCDecoder.prototype.DecodeIntArrayASCII=function(a,b,e,u,n,h,p){var r,g,k,m,w,t,y,v,A,x,B;g=this.m_iterator;r=this.m_streamType;m=this.m_triangleListDecoder.GetVertexToTriangle();w=m.m_neighbors;n=n.GetCoordIndex();t=g.m_count;y=p.ReadUInt32(g,r);v=p.ReadUChar(g,r);A=v>>>4&7;h.m_value=v&7;y-=g.m_count-t;t=new d.Iterator;t.m_count=
g.m_count+y;new d.SC3DMCTriplet(-1,-1,-1);if(A!==f.O3DGC_SC3DMC_BINARIZATION_ASCII)return d.O3DGC_ERROR_CORRUPTED_STREAM;p.ReadUInt32(t,r);y=this.m_neighbors;A=new d.NumberRef;r=h.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION;for(v=0;v<b;++v){A.m_value=0;if(0<m.GetNumNeighbors(v)&&r)for(x=m.Begin(v),k=m.End(v);x<k;++x){B=w[x];if(0>B)break;c(n,B,v,A,y,e,a,u)}if(1<A.m_value)for(B=p.ReadUCharASCII(t),x=0;x<e;++x)k=p.ReadIntASCII(g),a[v*u+x]=k+y[B].m_pred[x];else if(0<v&&h.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION)for(x=
0;x<e;++x)k=p.ReadIntASCII(g),a[v*u+x]=k+a[(v-1)*u+x];else for(x=0;x<e;++x)k=p.ReadUIntASCII(g),a[v*u+x]=k}g.m_count=t.m_count;return d.O3DGC_OK};d.SC3DMCDecoder.prototype.DecodeIntArray=function(a,b,c,d,e,h,p){return this.m_streamType===f.O3DGC_STREAM_TYPE_ASCII?this.DecodeIntArrayASCII(a,b,c,d,e,h,p):this.DecodeIntArrayBinary(a,b,c,d,e,h,p)};d.SC3DMCDecoder.prototype.ProcessNormals=function(a){var b,c,e,f,h,p,r,g;e=a.GetNNormal();f=3*a.GetNNormal();this.m_normalsSize<f&&(this.m_normalsSize=f,this.m_normals=
new Float32Array(this.m_normalsSize));f=this.m_normals;h=this.m_quantFloatArray;p=this.m_orientation;r=a.GetCoordIndex();a=a.GetNCoordIndex();var k,m,w,t;c=new d.Vec3;b=new d.Vec3;g=new d.Vec3;w=3*e;for(m=0;m<w;++m)f[m]=0;for(m=0;m<a;++m)k=3*m,w=3*r[k],t=3*r[k+1],k=3*r[k+2],b.m_x=h[t]-h[w],b.m_y=h[t+1]-h[w+1],b.m_z=h[t+2]-h[w+2],g.m_x=h[k]-h[w],g.m_y=h[k+1]-h[w+1],g.m_z=h[k+2]-h[w+2],c.m_x=b.m_y*g.m_z-b.m_z*g.m_y,c.m_y=b.m_z*g.m_x-b.m_x*g.m_z,c.m_z=b.m_x*g.m_y-b.m_y*g.m_x,f[w]+=c.m_x,f[w+1]+=c.m_y,
f[w+2]+=c.m_z,f[t]+=c.m_x,f[t+1]+=c.m_y,f[t+2]+=c.m_z,f[k]+=c.m_x,f[k+1]+=c.m_y,f[k+2]+=c.m_z;h=new d.Vec3;r=new d.Vec3;for(a=0;a<e;++a)b=3*a,h.m_x=f[b],h.m_y=f[b+1],h.m_z=f[b+2],b=Math.sqrt(h.m_x*h.m_x+h.m_y*h.m_y+h.m_z*h.m_z),0===b&&(b=1),g=h,c=r,t=w=m=void 0,m=Math.abs(g.m_x),w=Math.abs(g.m_y),t=Math.abs(g.m_z),t>=m&&t>=w?0<=g.m_z?(c.m_z=0,c.m_x=g.m_x,c.m_y=g.m_y):(c.m_z=1,c.m_x=-g.m_x,c.m_y=-g.m_y):w>=m&&w>=t?0<=g.m_y?(c.m_z=2,c.m_x=g.m_z,c.m_y=g.m_x):(c.m_z=3,c.m_x=-g.m_z,c.m_y=-g.m_x):0<=g.m_x?
(c.m_z=4,c.m_x=g.m_y,c.m_y=g.m_z):(c.m_z=5,c.m_x=-g.m_y,c.m_y=-g.m_z),g=r.m_x/b,b=r.m_y/b,c=r.m_z+p[a],p[a]=c,c>>>1!==r.m_z>>>1&&(b=g=0),c=2*a,f[c]=g,f[c+1]=b;return d.O3DGC_OK};d.SC3DMCDecoder.prototype.IQuantize=function(a,b,c,e,n,h,p,r){var g,k;if(r.m_value===f.O3DGC_SC3DMC_SURF_NORMALS_PREDICTION)for(k=f.CubeToSphere,r=this.m_orientation,g=this.m_normals,n=new d.Vec3(0,0,0),h=new d.Vec3(0,0,0),this.IQuantizeFloatArray(a,b,c,e,this.m_minNormal,this.m_maxNormal,p+1),c=0;c<b;++c)n.m_x=a[e*c]+g[2*
c],n.m_y=a[e*c+1]+g[2*c+1],n.m_z=r[c],k[n.m_z](n,h),a[e*c]=h.m_x,a[e*c+1]=h.m_y,a[e*c+2]=h.m_z;else this.IQuantizeFloatArray(a,b,c,e,n,h,p)};d.SC3DMCDecoder.prototype.DecodeFloatArrayBinary=function(a,l,s,u,n,h,p,r,g,k){var m,w,t,y,v,A,x,B,E,G,D,z,C,F,H,M,J,L,N,K,I;D=this.m_iterator;w=this.m_orientation;z=this.m_streamType;C=new d.ArithmeticDecoder;F=new d.StaticBitModel;H=new d.AdaptiveBitModel;M=new d.AdaptiveDataModel;m=f.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS;M.SetAlphabet(m+1);J=this.m_triangleListDecoder.GetVertexToTriangle();
L=J.m_neighbors;N=r.GetCoordIndex();y=l*s;K=D.m_count;I=k.ReadUInt32(D,z);v=k.ReadUChar(D,z);z=v>>>4&7;g.m_value=v&7;I-=D.m_count-K;K=new d.Iterator;K.m_count=D.m_count+I;if(z!==f.O3DGC_SC3DMC_BINARIZATION_AC_EGC)return d.O3DGC_ERROR_CORRUPTED_STREAM;k=k.GetBuffer(D,I);D.m_count+=I;C.SetBuffer(I,k);C.StartDecoder();I=C.ExpGolombDecode(0,F,H);k=C.ExpGolombDecode(0,F,H);z=new d.AdaptiveDataModel;z.SetAlphabet(k+2);if(g.m_value===f.O3DGC_SC3DMC_SURF_NORMALS_PREDICTION){this.m_orientationSize<y&&(this.m_orientationSize=
y,w=this.m_orientation=new Int8Array(this.m_orientationSize));s=new d.AdaptiveDataModel;s.SetAlphabet(12);for(x=0;x<l;++x)w[x]=b(C.DecodeAdaptiveDataModel(s));this.ProcessNormals(r);s=2}this.m_quantFloatArraySize<y&&(this.m_quantFloatArraySize=y,this.m_quantFloatArray=new Int32Array(this.m_quantFloatArraySize));y=this.m_quantFloatArray;v=this.m_neighbors;A=new d.NumberRef;r=g.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION;w=g.m_value===f.O3DGC_SC3DMC_PARALLELOGRAM_PREDICTION;for(B=0;B<l;++B){A.m_value=0;
if(0<J.GetNumNeighbors(B)&&r){E=J.Begin(B);G=J.End(B);if(w)for(t=E;t<G;++t){x=L[t];if(0>x)break;e(N,x,B,A,v,s,y,u,J,L)}if(A.m_value<m)for(t=E;t<G;++t){x=L[t];if(0>x)break;c(N,x,B,A,v,s,y,u)}}if(1<A.m_value)for(t=C.DecodeAdaptiveDataModel(M),x=0;x<s;++x)E=C.DecodeIntACEGC(z,F,H,I,k),y[B*u+x]=E+v[t].m_pred[x];else if(0<B&&r)for(x=0;x<s;++x)E=C.DecodeIntACEGC(z,F,H,I,k),y[B*u+x]=E+y[(B-1)*u+x];else for(x=0;x<s;++x)E=C.DecodeUIntACEGC(z,F,H,I,k),y[B*u+x]=E}D.m_count=K.m_count;this.IQuantize(a,l,s,u,n,
h,p,g);return d.O3DGC_OK};d.SC3DMCDecoder.prototype.DecodeFloatArrayASCII=function(a,b,s,u,n,h,p,r,g,k){var m,w,t,y,v,A,x,B,E,G,D,z,C,F,H;m=f.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS;t=this.m_iterator;w=this.m_orientation;y=this.m_streamType;A=this.m_triangleListDecoder.GetVertexToTriangle();x=A.m_neighbors;B=r.GetCoordIndex();E=b*s;G=t.m_count;D=k.ReadUInt32(t,y);z=k.ReadUChar(t,y);C=z>>>4&7;g.m_value=z&7;D-=t.m_count-G;G=new d.Iterator;G.m_count=t.m_count+D;if(C!==f.O3DGC_SC3DMC_BINARIZATION_ASCII)return d.O3DGC_ERROR_CORRUPTED_STREAM;
k.ReadUInt32(G,y);if(g.m_value===f.O3DGC_SC3DMC_SURF_NORMALS_PREDICTION){this.m_orientationSize<b&&(this.m_orientationSize=b,w=this.m_orientation=new Int8Array(this.m_orientationSize));for(z=0;z<b;++z)w[z]=k.ReadIntASCII(t);this.ProcessNormals(r);s=2}this.m_quantFloatArraySize<E&&(this.m_quantFloatArraySize=E,this.m_quantFloatArray=new Int32Array(this.m_quantFloatArraySize));E=this.m_quantFloatArray;y=this.m_neighbors;D=new d.NumberRef;r=g.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION;w=g.m_value===f.O3DGC_SC3DMC_PARALLELOGRAM_PREDICTION;
for(C=0;C<b;++C){D.m_value=0;if(0<A.GetNumNeighbors(C)&&r){v=A.Begin(C);F=A.End(C);if(w)for(z=v;z<F;++z){H=x[z];if(0>H)break;e(B,H,C,D,y,s,E,u,A,x)}if(D.m_value<m)for(z=v;z<F;++z){H=x[z];if(0>H)break;c(B,H,C,D,y,s,E,u)}}if(1<D.m_value)for(F=k.ReadUCharASCII(G),z=0;z<s;++z)v=k.ReadIntASCII(t),E[C*u+z]=v+y[F].m_pred[z];else if(0<C&&g.m_value!==f.O3DGC_SC3DMC_NO_PREDICTION)for(z=0;z<s;++z)v=k.ReadIntASCII(t),E[C*u+z]=v+E[(C-1)*u+z];else for(z=0;z<s;++z)v=k.ReadUIntASCII(t),E[C*u+z]=v}t.m_count=G.m_count;
this.IQuantize(a,b,s,u,n,h,p,g);return d.O3DGC_OK};d.SC3DMCDecoder.prototype.DecodeFloatArray=function(a,b,c,d,e,h,p,r,g,k){return this.m_streamType===f.O3DGC_STREAM_TYPE_ASCII?this.DecodeFloatArrayASCII(a,b,c,d,e,h,p,r,g,k):this.DecodeFloatArrayBinary(a,b,c,d,e,h,p,r,g,k)};d.SC3DMCDecoder.prototype.IQuantizeFloatArray=function(a,b,c,e,f,h,p){var r,g,k,m;r=this.m_idelta;g=this.m_quantFloatArray;for(k=0;k<c;++k)m=h[k]-f[k],r[k]=0<m?m/((1<<p>>>0)-1):1;for(h=0;h<b;++h)for(k=0;k<c;++k)a[h*e+k]=g[h*e+
k]*r[k]+f[k];return d.O3DGC_OK};d.SC3DMCDecoder.prototype.DecodePlayload=function(a,b){var c,e,f,h,p,r,g;c=this.m_params;e=this.m_iterator;f=this.m_stats;h=new d.NumberRef;p=new d.Timer;r=d.O3DGC_OK;this.m_triangleListDecoder.SetStreamType(this.m_streamType);f.m_streamSizeCoordIndex=e.m_count;p.Tic();this.m_triangleListDecoder.Decode(a.GetCoordIndex(),a.GetNCoordIndex(),a.GetNCoord(),b,e);p.Toc();f.m_timeCoordIndex=p.GetElapsedTime();f.m_streamSizeCoordIndex=e.m_count-f.m_streamSizeCoordIndex;f.m_streamSizeCoord=
e.m_count;p.Tic();0<a.GetNCoord()&&(r=this.DecodeFloatArray(a.GetCoord(),a.GetNCoord(),3,3,a.GetCoordMinArray(),a.GetCoordMaxArray(),c.GetCoordQuantBits(),a,h,b),c.SetCoordPredMode(h.m_value));if(r!==d.O3DGC_OK)return r;p.Toc();f.m_timeCoord=p.GetElapsedTime();f.m_streamSizeCoord=e.m_count-f.m_streamSizeCoord;f.m_streamSizeNormal=e.m_count;p.Tic();0<a.GetNNormal()&&(r=this.DecodeFloatArray(a.GetNormal(),a.GetNNormal(),3,3,a.GetNormalMinArray(),a.GetNormalMaxArray(),c.GetNormalQuantBits(),a,h,b),c.SetNormalPredMode(h.m_value));
if(r!==d.O3DGC_OK)return r;p.Toc();f.m_timeNormal=p.GetElapsedTime();f.m_streamSizeNormal=e.m_count-f.m_streamSizeNormal;for(g=0;g<a.GetNumFloatAttributes();++g)f.m_streamSizeFloatAttribute[g]=e.m_count,p.Tic(),r=this.DecodeFloatArray(a.GetFloatAttribute(g),a.GetNFloatAttribute(g),a.GetFloatAttributeDim(g),a.GetFloatAttributeDim(g),a.GetFloatAttributeMinArray(g),a.GetFloatAttributeMaxArray(g),c.GetFloatAttributeQuantBits(g),a,h,b),c.SetFloatAttributePredMode(g,h.m_value),p.Toc(),f.m_timeFloatAttribute[g]=
p.GetElapsedTime(),f.m_streamSizeFloatAttribute[g]=e.m_count-f.m_streamSizeFloatAttribute[g];if(r!==d.O3DGC_OK)return r;for(g=0;g<a.GetNumIntAttributes();++g)f.m_streamSizeIntAttribute[g]=e.m_count,p.Tic(),r=this.DecodeIntArray(a.GetIntAttribute(g),a.GetNIntAttribute(g),a.GetIntAttributeDim(g),a.GetIntAttributeDim(g),a,h,b),c.SetIntAttributePredMode(g,h.m_value),p.Toc(),f.m_timeIntAttribute[g]=p.GetElapsedTime(),f.m_streamSizeIntAttribute[g]=e.m_count-f.m_streamSizeIntAttribute[g];if(r!==d.O3DGC_OK)return r;
...
1);return d.O3DGC_OK};d.DynamicVectorDecoder.prototype.IPredict=function(a,b,c){var e;e=c-1;for(c=1;c<e;)a[b+c]+=a[b+c-1]+a[b+c+1]+1>>1,c+=2;c===e&&(a[b+c]+=a[b+c-1]);return d.O3DGC_OK};d.DynamicVectorDecoder.prototype.Merge=function(a,b,c){var e,f,h;e=(c>>1)+(c&1);c=e-1;for(f=e;0<c;){for(e=c;e<f;e+=2)h=a[b+e],a[b+e]=a[b+e+1],a[b+e+1]=h;--c;++f}return d.O3DGC_OK};d.DynamicVectorDecoder.prototype.ITransform=function(a,b,c){var e,f;f=0;for(e=0+((c&1)<<f++>>>0);1<c;)c=(c>>1)+((c&1)>>>0),e+=(c&1)<<f++>>>
0;for(f-=2;0<=f;--f)c=(c<<1>>>0)-(e>>>f&1)>>>0,this.Merge(a,b,c),this.IUpdate(a,b,c),this.IPredict(a,b,c);return d.O3DGC_OK};d.DynamicVectorDecoder.prototype.IQuantize=function(a,b,c,e,f,h,p){var r,g,k,m;r=this.m_quantVectors;for(k=0;k<c;++k)for(g=h[k]-f[k],g=0<g?g/((1<<p>>>0)-1):1,m=0;m<b;++m)a[m*e+k]=r[m+k*b]*g+f[k];return d.O3DGC_OK};d.DynamicVectorDecoder.prototype.DecodeHeader=function(a,b){var c,e,n;c=this.m_iterator;e=c.m_count;n=b.ReadUInt32(c,f.O3DGC_STREAM_TYPE_BINARY);if(n!==f.O3DGC_DV_START_CODE){c.m_count=
e;n=b.ReadUInt32(c,f.O3DGC_STREAM_TYPE_ASCII);if(n!==f.O3DGC_DV_START_CODE)return d.O3DGC_ERROR_CORRUPTED_STREAM;this.m_streamType=f.O3DGC_STREAM_TYPE_ASCII}else this.m_streamType=f.O3DGC_STREAM_TYPE_BINARY;e=this.m_streamType;this.m_streamSize=b.ReadUInt32(c,e);this.m_params.SetEncodeMode(b.ReadUChar(c,e));a.SetNVector(b.ReadUInt32(c,e));0<a.GetNVector()&&(a.SetDimVector(b.ReadUInt32(c,e)),this.m_params.SetQuantBits(b.ReadUChar(c,e)));return d.O3DGC_OK};d.DynamicVectorDecoder.prototype.DecodePlayload=
function(a,b){var c,e,n,h,p,r,g,k,m,w,t,y,v;e=this.m_iterator;n=this.m_streamType;h=d.O3DGC_OK;p=e.m_count;r=b.ReadUInt32(e,n);g=a.GetDimVector();k=a.GetNVector();c=g*k;for(m=0;m<a.GetDimVector();++m)a.SetMin(m,b.ReadFloat32(e,n)),a.SetMax(m,b.ReadFloat32(e,n));m=new d.ArithmeticDecoder;w=new d.StaticBitModel;t=new d.AdaptiveBitModel;r-=e.m_count-p;y=p=0;n===f.O3DGC_STREAM_TYPE_BINARY&&(p=b.GetBuffer(e,r),e.m_count+=r,m.SetBuffer(r,p),m.StartDecoder(),p=m.ExpGolombDecode(0,w,t),y=m.ExpGolombDecode(0,
w,t));r=new d.AdaptiveDataModel;r.SetAlphabet(y+2);this.m_maxNumVectors<c&&(this.m_maxNumVectors=c,this.m_quantVectors=new Int32Array(this.m_maxNumVectors));c=this.m_quantVectors;if(n===f.O3DGC_STREAM_TYPE_ASCII)for(n=0;n<k;++n)for(v=0;v<g;++v)c[v*k+n]=b.ReadIntASCII(e);else for(n=0;n<k;++n)for(v=0;v<g;++v)c[v*k+n]=m.DecodeIntACEGC(r,w,t,p,y);for(v=0;v<g;++v)this.ITransform(c,v*k,k);this.IQuantize(a.GetVectors(),k,g,a.GetStride(),a.GetMinArray(),a.GetMaxArray(),this.m_params.GetQuantBits());return h};
return d}();SEA3D.GeometryGC=function(a,b,c){this.name=a;this.data=b;this.sea3d=c;var e=b.readUShort();a=[];var d,f;this.isBig=0!=(e&1);b.readVInt=this.isBig?b.readUInt:b.readUShort;if(e&2){this.groups=[];var q=b.readUByte(),l=0;for(c=0;c<q;c++){var s=3*b.readVInt();this.groups.push({start:l,count:s});l+=s}}else this.groups=[];if(e&4)for(this.uv=[],q=b.readUByte(),c=0;c<q;c++)a[c]=b.readUByte();e&32&&(d=b.readUByte(),f=b.readUByte());c=b.readUInt();c=b.concat(b.position,c);b=new o3dgc.BinaryStream(c.buffer);
e=new o3dgc.SC3DMCDecoder;q=new o3dgc.IndexedFaceSet;e.DecodeHeader(q,b);c=q.GetNCoordIndex();l=q.GetNCoord();this.groups.length||this.groups.push({start:0,count:3*c});this.indexes=this.isBig?new Uint32Array(3*c):new Uint16Array(3*c);this.vertex=new Float32Array(3*l);q.SetCoordIndex(this.indexes);q.SetCoord(this.vertex);0<q.GetNNormal()&&(this.normal=new Float32Array(3*l),q.SetNormal(this.normal));for(c=0;c<a.length;c++)this.uv[c]=new Float32Array(2*l),q.SetFloatAttribute(a[c],this.uv[c]);void 0!==
d&&(this.jointPerVertex=q.GetIntAttributeDim(d),this.joint=new Uint16Array(l*this.jointPerVertex),this.weight=new Float32Array(l*this.jointPerVertex),q.SetIntAttribute(d,this.joint),q.SetFloatAttribute(f,this.weight));e.DecodePlayload(q,b)};SEA3D.GeometryGC.prototype.type="s3D";SEA3D.GeometryUpdateGC=function(a,b,c){this.name=a;this.data=b;this.sea3d=c;this.index=b.readUInt();this.bytes=b.concat(b.position,b.length-b.position)};SEA3D.GeometryUpdateGC.prototype.type="us3D";
