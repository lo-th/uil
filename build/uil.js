	...
	*/
	...
	class Gui {
	  ...
	  triggerMouseDown(x, y) {
	    console.warn("Gui.triggerMouseDown is deprecated, use triggerMouseDownUV instead");
	    /*
	    Roots.handleEvent({
	      type: "pointerdown",
	      clientX: x,
	  ...
	  triggerMouseMove() {
	    console.warn("Gui.triggerMouseMove is deprecated, use triggerMouseMoveUV instead");
	    /*
	    Roots.handleEvent({
	      type: "pointermove",
	      clientX: -1,
	  ...
	  triggerMouseUp(x, y) {
	    ...
	    console.warn("Gui.triggerMouseUp is deprecated, use triggerMouseUpUV instead");
	    /*
	    Roots.handleEvent({
	      type: "pointerup",
	      clientX: x,
	  ...
	  triggerMouseDownUV(u, v, { flipY = true } = {}) {
	    ...
	    Roots.handleEvent({
	      type: "pointerdown",
	      clientX: isNaN(x) ? null : x,
	      clientY: isNaN(y) ? null : y,
	      delta: 0,
	      key: null,
	      keyCode: NaN,
	    });
