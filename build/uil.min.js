...
UIL.Number.prototype.constructor=UIL.Number;UIL.Number.prototype.rSize=function(){UIL.Proto.prototype.rSize.call(this);this.w=(this.sb+5)/this.length-5;for(var a=this.length;a--;)this.setDom(2+a,"left",this.sa+this.w*a+5*a),this.setDom(2+a,"width",this.w)};UIL.Color=function(a){UIL.Proto.call(this,a);this.type=a.type||"array";this.width=this.sb;this.oldWidth=0;this.side=a.side||"down";this.holdBottom=this.holdTop=0;this.wheelWidth=0.1*this.width;this.decal=22;this.radius=0.5*(this.width-this.wheelWidth)-1;this.square=Math.floor(0.7*(this.radius-0.5*this.wheelWidth))-1;this.mid=Math.floor(0.5*this.width);this.markerSize=0.3*this.wheelWidth;this.c[2]=UIL.DOM("UIL svgbox","rect","",{width:this.sb,height:17,fill:"#000","stroke-width":1,stroke:UIL.SVGC});
this.c[3]=UIL.DOM("UIL text");"up"==this.side&&(this.decal=5,this.c[3].style.top="auto",this.c[2].style.top="auto",this.c[3].style.bottom="2px",this.c[2].style.bottom="2px");this.c[4]=UIL.DOM("UIL","rect","left:"+this.sa+"px;  top:"+this.decal+"px; width:"+this.width+"px; height:"+this.width+"px;",{x:this.mid-this.square,y:this.mid-this.square,width:2*this.square-1,height:2*this.square-1,fill:"#000"});this.c[5]=UIL.DOM("UIL","canvas","left:"+this.sa+"px;  top:"+this.decal+"px; display:none;");this.c[6]=
UIL.DOM("UIL","canvas","left:"+this.sa+"px;  top:"+this.decal+"px; pointer-events:auto; cursor:pointer; display:none;");"up"==this.side&&(this.c[6].style.pointerEvents="none");this.c[5].width=this.c[5].height=this.width;this.c[6].width=this.c[6].height=this.width;this.ctxMask=this.c[5].getContext("2d");this.ctxOverlay=this.c[6].getContext("2d");this.ctxMask.translate(this.mid,this.mid);this.ctxOverlay.translate(this.mid,this.mid);this.hsl=null;this.value="#ffffff";a.value&&(a.value instanceof Array?
this.value=UIL.pack(a.value):isNaN(a.value)?this.value=a.value:this.value=UIL.numFormat(a.value));this.bcolor=null;this.isShow=this.down=!1;this.f[0]=function(a){if(this.isShow)this.f[4]();else this.f[5]()}.bind(this);this.f[1]=function(a){this.down||(this.down=!0,this.c[6].onmousemove=this.f[2],this.c[6].onmouseup=this.f[3]);this.offset=this.c[6].getBoundingClientRect();var c=this.widgetCoords(a);this.circleDrag=Math.max(Math.abs(c.x),Math.abs(c.y))>this.square+2;this.f[2](a);return!1}.bind(this);
this.f[2]=function(a){var c=this.widgetCoords(a);this.circleDrag?(a=Math.atan2(c.x,-c.y)/6.28,this.setHSL([(a+1)%1,this.hsl[1],this.hsl[2]])):(a=Math.max(0,Math.min(1,-(c.x/this.square*0.5)+0.5)),c=Math.max(0,Math.min(1,-(c.y/this.square*0.5)+0.5)),this.setHSL([this.hsl[0],a,c]));return!1}.bind(this);this.f[3]=function(a){this.c[6].onmouseup=null;this.c[6].onmousemove=null;this.down=!1}.bind(this);this.f[4]=function(){this.isShow=!1;this.h=20;"up"==this.side&&(isNaN(this.holdTop)||(this.c[0].style.top=
this.holdTop+"px"),this.c[6].style.pointerEvents="none");this.c[0].style.height=this.h+"px";this.c[4].style.display="none";this.c[5].style.display="none";this.c[6].style.display="none";this.c[6].onmousedown=null;this.c[6].onmouseout=null;UIL.main.calc()}.bind(this);this.f[5]=function(){if(this.oldWidth!==this.width)this.f[6]();this.isShow=!0;this.h=this.width+30;this.c[0].style.height=this.h+"px";console.log(this.c[0].style.top.substring(0,this.c[0].style.top.length-2));"up"==this.side&&(this.holdTop=
1*this.c[0].style.top.substring(0,this.c[0].style.top.length-2)||"auto",isNaN(this.holdTop)||(this.c[0].style.top=this.holdTop-(this.h-20)+"px"),setTimeout(function(){this.c[6].style.pointerEvents="auto"}.bind(this),100));this.c[4].style.display="block";this.c[5].style.display="block";this.c[6].style.display="block";this.c[6].onmousedown=this.f[1];this.c[6].onmouseout=this.f[4];UIL.main.calc()}.bind(this);this.f[6]=function(){this.oldWidth=this.width;this.drawCircle();this.drawMask();this.drawMarkers()}.bind(this);
...
"px";this.c[6].style.top=this.decal+"px";this.ctxMask.translate(this.mid,this.mid);this.ctxOverlay.translate(this.mid,this.mid);this.isShow&&(this.f[6](),this.h=this.width+30,this.setDom(0,"height",this.h),UIL.main.calc())};UIL.hexToHtml=function(a){return"#"+("000000"+a.toString(16)).substr(-6)};UIL.numFormat=function(a){return"#"+("000000"+a.toString(16)).substr(-6)};UIL.hexFormat=function(a){return a.toUpperCase().replace("#","0x")};
