...
f.setAttribute("id",c);b.appendChild(f);(f.sheet||{}).insertRule?f.sheet.insertRule(e+c+"{"+d+"}",0):(f.styleSheet||f.sheet).addRule(e+c,d)};return Crea}();var define,module,exports,UIL=UIL||function(){return{main:null,REVISION:"0.9",DEF:!1,WIDTH:300,BW:190,AW:100,UNS:"-o-user-select:none; -ms-user-select:none; -khtml-user-select:none; -webkit-user-select:none; -moz-user-select:none;",US:"-o-user-select:text; -ms-user-select:text; -khtml-user-select:text; -webkit-user-select:text; -moz-user-select:text;",TXT:'font-family:"Lucida Console", Monaco, monospace; font-size:11px; color:#cccccc; background:none; padding:3px 10px; left:0; top:0; height:17px; width:100px; overflow:hidden; white-space: nowrap;',
DOM:Crea.dom,CC:Crea.cc,setDom:Crea.setDom,setSvg:Crea.setSvg,COLOR:"N",SELECT:"#035fcf",MOVING:"#03afff",SELECTDOWN:"#024699",SVGB:"rgba(0,0,0,0.2)",SVGC:"rgba(120,120,120,0.6)",BorderSelect:"rgba(3,95,207,0.6)",sizer:function(a){this.WIDTH=~~a;a=this.WIDTH/3;this.BW=~~(2*a-10);this.AW=~~a;this.main&&this.main.changeWidth()},classDefine:function(){UIL.CC("UIL",UIL.UNS+" position:absolute; pointer-events:none; box-sizing:border-box; margin:0; padding:0; border:none; ");UIL.CC("UIL.content"," display:block; width:300px; height:auto; top:0; left:0; overflow:hidden; background:none; transition:height, 0.1s ease-out;");
UIL.CC("UIL.inner","width:100%; top:0; left:0; height:auto; overflow:hidden; background:none; ");UIL.CC("UIL.bottom",UIL.TXT+"width:100%; top:auto; bottom:0; left:0; height:20px; overflow:hidden; background:none; text-align:center; padding:5px 10px; pointer-events:auto; cursor:pointer;");UIL.CC("UIL.base","position:relative; height:20px; overflow:hidden; float: left");UIL.CC("UIL.text",UIL.TXT);UIL.CC("UIL.textSelect",UIL.TXT+UIL.US+"outline:none; -webkit-appearance:none; -moz-appearance:none; border:1px solid rgba(255,255,255,0.1);");
UIL.CC("UIL.list","box-sizing:content-box; border:20px solid transparent; border-bottom:10px solid transparent; left:80px; top:0px; width:190px; height:90px; overflow:hidden; cursor:s-resize; pointer-events:auto; display:none;");UIL.CC("UIL.list-in","left:0; top:0; width:100%; background:rgba(0,0,0,0.2); ");UIL.CC("UIL.listItem","position:relative; height:18px; background:rgba(0,0,0,0.2); border-bottom:1px solid rgba(0,0,0,0.2); pointer-events:auto; cursor:pointer;"+UIL.TXT);UIL.CC("UIL.listItem:hover",
"background:"+UIL.SELECT+"; color:#FFFFFF;");UIL.CC("UIL.scroll-bg","cursor:w-resize; pointer-events:auto; background-image:linear-gradient(to right,  rgba(255,255,255,0),  rgba(255,255,255,0.1));");UIL.CC("UIL.scroll"," background:rgba(255,255,255,0.2);");UIL.CC("UIL.svgbox","left:100px; top:1px; width:190px; height:17px; pointer-events:auto; cursor:pointer;");UIL.DEF=!0},bgcolor:function(a,b){var c=48,d=48,e=48;b=b||0.66;if(a)switch(a){case "r":case "R":case "S":c=160;e=68;break;case "g":case "G":case "E":d=
120;e=68;break;case "b":case "B":case "T":e=120;d=68;break;case "no":case "NO":b=0}c="rgba("+c+","+d+","+e+","+b+")";0===b&&(c="none");return c}}}();UIL.classDefine();(function(a){"function"===typeof define&&define.amd?define("uil",UIL):"undefined"!==typeof exports&&"undefined"!==typeof module?module.exports=UIL:a.UIL=UIL})(this);UIL.Gui=function(a,b,c,d){UIL.sizer(b||300);UIL.main=this;this.color=d||UIL.COLOR;this.isCenter=c||!1;this.lockwheel=!1;this.isOpen=!0;this.uis=[];this.content=UIL.DOM("UIL content","div",a);document.body.appendChild(this.content);this.inner=UIL.DOM("UIL inner");this.content.appendChild(this.inner);this.inner.name="inner";this.scrollBG=UIL.DOM("UIL scroll-bg","div","right:0; top:0; width:10px; height:10px; cursor:s-resize; display:none; ");this.content.appendChild(this.scrollBG);this.scrollBG.name=
"scroll";this.scroll=UIL.DOM("UIL scroll","div","left:4px; top:0; width:3px; height:10px;  ");this.scrollBG.appendChild(this.scroll);this.bottom=UIL.DOM("UIL bottom");this.content.appendChild(this.bottom);this.bottom.textContent="close";this.bottom.name="bottom";this.bottom.style.background=UIL.bgcolor(this.color);this.changeWidth();this.isScroll=this.isDown=!1;this.content.addEventListener("mousedown",this,!1);this.content.addEventListener("mousemove",this,!1);this.content.addEventListener("mouseout",
this,!1);this.content.addEventListener("mouseup",this,!1);this.content.addEventListener("mouseover",this,!1);this.content.addEventListener("mousewheel",this,!1);window.addEventListener("resize",function(a){this.resize(a)}.bind(this),!1);this.resize()};
...
UIL.RGBtoHSL=function(a){var b=a[0],c=a[1];a=a[2];var d=Math.min(b,c,a),e=Math.max(b,c,a),g=e-d,h=0,k=0,d=(d+e)/2;0<d&&1>d&&(k=g/(0.5>d?2*d:2-2*d));0<g&&(e==b&&e!=c&&(h+=(c-a)/g),e==c&&e!=a&&(h+=2+(a-b)/g),e==a&&e!=b&&(h+=4+(b-c)/g),h/=6);return[h,k,d]};UIL.Slide=function(a){UIL.Proto.call(this,a);this.type="slide";this.setTypeNumber(a);this.range=this.max-this.min;this.width=UIL.BW-40;this.w=this.width-8;this.h=a.height||20;this.h=11>this.h?11:this.h;this.value=a.value||0;this.isOver=this.isDown=!1;a=0.5*a.height-10;void 0!==this.c[1]&&(this.c[1].style.top=a+"px");this.c[2]=UIL.DOM("UIL text","div","top:"+a+"px; text-align:right; width:40px; padding:3px 5px; color:"+this.fontColor);this.c[3]=UIL.DOM("UIL svgbox","rect","width:"+this.width+"px; height:"+
(this.h-3)+"px; cursor:w-resize;",{width:"100%",height:this.h-3,fill:UIL.SVGB,"stroke-width":1,stroke:UIL.SVGC});this.c[4]=UIL.DOM("UIL svgbox","rect","width:"+this.width+"px; height:"+(this.h-3)+"px; pointer-events:none;",{x:4,y:4,width:this.width-8,height:this.h-10,fill:this.fontColor});UIL.DOM(null,"defs",null,{},this.c[3]);UIL.DOM(null,"pattern",null,{id:"sripe",x:0,y:0,width:10,height:10,patternUnits:"userSpaceOnUse"},this.c[3],1);UIL.DOM(null,"line",null,{x1:5,x2:0,y1:0,y2:10,stroke:UIL.SVGC,
...
UIL.Circular.prototype.makePath=function(){var a=this.radius,b=this.percent*this.twoPi-0.001,c=a+a*Math.sin(0),d=a-a*Math.cos(0),e=a+a*Math.sin(b),g=a-a*Math.cos(b);return"M "+a+","+a+" L "+c+","+d+" A "+a+","+a+" 0 "+(b-0>Math.PI?1:0)+" 1 "+e+","+g+" Z"};UIL.Circular.prototype.update=function(a){this.c[2].textContent=this.value;this.percent=(this.value-this.min)/this.range;UIL.setSvg(this.c[4],"d",this.makePath());a&&this.callback(this.value)};UIL.Knob=function(a){UIL.Proto.call(this,a);this.type="knob";this.setTypeNumber(a);this.range=this.max-this.min;this.value=a.value||0;this.radius=a.radius||15;this.size=2*this.radius+20;void 0!==a.size&&(this.size=a.size,this.radius=0.5*~~(this.size-20));this.w=2*this.radius;this.height=2*this.radius;this.h=a.height||this.height+40;this.twoPi=2*Math.PI;this.mPI=0.8*Math.PI;this.toDeg=180/Math.PI;this.top=0;this.c[0].style.width=this.size+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.size+"px",
this.c[1].style.textAlign="center",this.top=20);this.percent=0;this.c[2]=UIL.DOM("UIL text","div","top:"+(this.height+20)+"px; text-align:center; width:"+this.size+"px; padding:3px 5px; color:"+this.fontColor);this.c[3]=UIL.DOM("UIL svgbox","circle","left:10px; top:"+this.top+"px; width:"+this.w+"px; height:"+this.height+"px; cursor:pointer;",{cx:this.radius,cy:this.radius,r:this.radius-4,fill:"rgba(0,0,0,0.3)"});this.c[4]=UIL.DOM("UIL svgbox","path","left:10px; top:"+this.top+"px; width:"+this.w+
"px; height:"+this.height+"px; pointer-events:none;",{d:this.makeGrad(),"stroke-width":1,stroke:UIL.SVGC});this.c[5]=UIL.DOM("UIL svgbox","circle","left:10px; top:"+this.top+"px; width:"+this.w+"px; height:"+this.height+"px; pointer-events:none;",{cx:this.radius,cy:this.radius,r:0.7*this.radius,fill:UIL.bgcolor(UIL.COLOR,1),"stroke-width":1,stroke:UIL.SVGC});UIL.DOM(null,"circle",null,{cx:this.radius,cy:0.5*this.radius,r:3,fill:this.fontColor},this.c[5]);this.c[3].events=["mouseover","mousedown",
"mouseout"];this.r=0;this.init();this.update()};UIL.Knob.prototype=Object.create(UIL.Proto.prototype);UIL.Knob.prototype.constructor=UIL.Knob;UIL.Knob.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "mouseover":this.over(a);break;case "mousedown":this.down(a);break;case "mouseout":this.out(a);break;case "mouseup":this.up(a);break;case "mousemove":this.move(a)}};
