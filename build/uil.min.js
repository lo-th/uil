...
a+"px";this.py=a},add:function(a,b){b.isUI=!0;var c;switch(a){case "button":c=new UIL.Button(b);break;case "string":c=new UIL.String(b);break;case "number":c=new UIL.Number(b);break;case "title":c=new UIL.Title(b);break;case "color":c=new UIL.Color(b);break;case "slide":c=new UIL.Slide(b);break;case "bool":c=new UIL.Bool(b);break;case "list":c=new UIL.List(b);break;case "group":c=new UIL.Group(b);break;case "knob":c=new UIL.Knob(b);break;case "circular":c=new UIL.Circular(b);break;case "joystick":c=
new UIL.Joystick(b)}this.uis.push(c);this.calc();return c},resize:function(a){this.calc();this.testHeight()},remove:function(a){a=this.uis.indexOf(a);-1!==a&&(this.uis[a].clear(),this.uis.splice(a,1))},clear:function(){this.update(0);for(var a=this.uis.length;a--;)this.uis[a].clear(),this.uis[a]=null,this.uis.pop();this.uis=[];this.calc()},showScroll:function(a){this.isScroll=!0;this.total=this.height-20;this.maxView=this.maxHeight-20;this.ratio=this.maxView/this.total;this.sh=this.maxView*this.ratio;
20>this.sh&&(this.sh=20);this.range=this.maxView-this.sh;this.scrollBG.style.display="block";this.scrollBG.style.height=this.maxView+"px";this.scroll.style.height=this.sh+"px";this.update(0)},hideScroll:function(){this.isScroll=!1;this.update(0);this.scrollBG.style.display="none"},calc:function(a){void 0!==a?(this.height+=a,this.content.style.height=this.height+"px"):(this.height=this.inner.offsetHeight+20,this.content.style.height=this.height+"px","close"!==this.bottom.textContent&&(this.bottom.textContent=
"close"));this.tmp=setTimeout(this.testHeight.bind(this),10)},testHeight:function(){this.tmp&&clearTimeout(this.tmp);this.top=this.content.getBoundingClientRect().top;this.maxHeight=window.innerHeight-this.top-10;this.height>this.maxHeight?(this.content.style.height=this.maxHeight+"px",this.bottom.style.background=UIL.bgcolor(this.color,1),this.showScroll()):(this.hideScroll(),this.bottom.style.background=UIL.bgcolor(this.color))},changeWidth:function(){this.width=UIL.WIDTH;this.content.style.width=
