...
"x"+this.value[0]+" y"+this.value[1];UIL.setSvg(this.c[3],"cx",d);UIL.setSvg(this.c[3],"cy",e);UIL.setSvg(this.c[4],"cx",b);UIL.setSvg(this.c[4],"cy",c);this.oldx=this.x;this.oldy=this.y;a&&this.send();null!==this.interval&&0===this.x&&0===this.y&&(clearInterval(this.interval),this.interval=null)};UIL.Fps=function(a){UIL.Proto.call(this,a);this.autoHeight=!0;this.baseH=this.h;this.hplus=50;this.nFrame=40;this.l=1;this.pa1=[];this.pa2=[];this.pa3=[];for(var b=this.nFrame+1;b--;)this.pa1.push(43),this.pa2.push(43),this.pa3.push(43);this.c[1].textContent="FPS";this.c[0].style.cursor="pointer";this.c[0].style.pointerEvents="auto";this.c[2]=UIL.DOM(null,"path",UIL.BASIC+("display:none; left:10px; top:"+this.h+"px; height:"+(this.hplus-8)+"px; background: rgba(255, 255, 255, 0.1);border:1px solid rgba(255, 255, 255, 0.2); "),
{fill:"none","stroke-width":1,stroke:this.fontColor,"vector-effect":"non-scaling-stroke"});this.c[2].setAttribute("viewBox","0 0 40 42");this.c[2].setAttribute("height","42px");this.c[2].setAttribute("preserveAspectRatio","none");UIL.DOM(null,"path",null,{fill:"none","stroke-width":1,stroke:"#FF0","vector-effect":"non-scaling-stroke"},this.c[2]);UIL.DOM(null,"path",null,{fill:"none","stroke-width":1,stroke:"#0FF","vector-effect":"non-scaling-stroke"},this.c[2]);this.c[3]=UIL.DOM(null,"div",UIL.BASIC+
"width:100%; bottom:0px; height:1px; background: rgba(255, 255, 255, 0.2);");this.isShow=a.show||!1;this.now=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now;this.prevTime=this.startTime=this.now();this.frames=0;this.isMem=!1;this.mm=this.mem=this.fps=this.ms=0;self.performance&&self.performance.memory&&(this.isMem=!0);this.c[0].events=["click","mousedown","mouseover","mouseout"];this.init()};UIL.Fps.prototype=Object.create(UIL.Proto.prototype);
...
UIL.Fps.prototype.mode=function(a){var b=this.s;switch(a){case 0:b[1].color=this.fontColor;b[1].background="none";break;case 1:b[1].color="#FFF";b[1].background=UIL.SELECT;break;case 2:b[1].color=this.fontColor,b[1].background=UIL.SELECTDOWN}};UIL.Fps.prototype.makePath=function(a){for(var b=[],c=0;c<this.nFrame+1;c++)0===c?b.push("M "+c+" "+a[c]):b.push(" L "+c+" "+a[c]);return b};
UIL.Fps.prototype.drawGraph=function(){this.pa1.shift();this.pa1.push(Math.floor(8+Math.min(30,30-this.fps/100*30))+0.5);UIL.setSvg(this.c[2],"d",this.makePath(this.pa1),0);this.pa2.shift();this.pa2.push(Math.floor(8+Math.min(30,30-this.ms/200*30))+0.5);UIL.setSvg(this.c[2],"d",this.makePath(this.pa2),1);this.isMem&&(this.pa3.shift(),this.pa3.push(Math.floor(8+Math.min(30,30-30*this.mm))+0.5),UIL.setSvg(this.c[2],"d",this.makePath(this.pa3),2))};
...
UIL.Fps.prototype.hide=function(){this.h=this.baseH;null!==this.parentGroup?this.parentGroup.calc(-this.hplus):this.isUI&&this.main.calc(-this.hplus);this.s[0].height=this.h+"px";this.s[2].display="none";this.isShow=!1;UIL.removeListen(this);this.c[1].textContent="FPS"};
UIL.Fps.prototype.rSize=function(){this.s[0].width=this.width+"px";this.s[1].width=this.width+"px";var a=Math.floor((this.width-20)/this.nFrame)*this.nFrame+2,b=Math.round(0.5*(this.width-a));this.s[2].left=b+"px";this.s[2].width=a+"px";this.c[2].setAttribute("width",a+"px")};UIL.Fps.prototype.begin=function(){this.startTime=this.now()};
