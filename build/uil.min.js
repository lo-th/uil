...
"px solid transparent";this.c[5].style.color=this.fontColor;this.c[2].events="mousedown mousemove mouseup mouseout mousewheel mouseover".split(" ");this.c[3].events=["click","mousedown","mouseover","mouseout"];this.list=a.list||[];this.baseH=this.h;this.isShow=!1;this.maxItem=a.maxItem||5;this.itemHeight=a.itemHeight||this.h-3;this.length=this.list.length;this.full=a.full||!1;this.maxHeight=this.maxItem*(this.itemHeight+1);this.py=0;this.w=this.sb;this.isDown=this.scroll=!1;this.side=a.side||"down";
this.holdTop=0;"up"===this.side&&(this.c[2].style.top="auto",this.c[3].style.top="auto",this.c[4].style.top="auto",this.c[5].style.top="auto",this.c[2].style.bottom="10px",this.c[3].style.bottom="2px",this.c[4].style.bottom="2px",this.c[5].style.bottom="2px");this.listIn=UIL.DOM(null,"div",UIL.BASIC+"left:0; top:0; width:100%; background:rgba(0,0,0,0.2); ");this.listIn.name="list";this.c[2].style.height=this.maxHeight+"px";this.c[2].appendChild(this.listIn);this.setList(this.list,a.value);this.init()};
UIL.List.prototype=Object.create(UIL.Proto.prototype);UIL.List.prototype.constructor=UIL.List;UIL.List.prototype.clearList=function(){for(;this.listIn.children.length;)this.listIn.removeChild(this.listIn.lastChild)};
UIL.List.prototype.setList=function(a,b){this.clearList();this.list=a;this.length=this.list.length;this.full&&(this.maxItem=this.length);this.max=this.length*(this.itemHeight+1);this.ratio=this.maxHeight/this.max;this.sh=this.maxHeight*this.ratio;this.range=this.maxHeight-this.sh;this.c[6].style.height=this.sh+"px";this.max>this.maxHeight&&(this.w=this.sb-20,this.scroll=!0);for(var c,d,e=0;e<this.length;e++)d=this.list[e],c=UIL.DOM(null,"div",UIL.ITEM+"width:"+this.w+"px; height:"+this.itemHeight+
