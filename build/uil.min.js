...
"; height:"+(this.h-2)+"px;");this.c[4]=UIL.DOM(null,"div",UIL.BASIC+"position:absolute; width:10px; height:10px; left:"+(this.sa+this.sb-5)+"px; top:"+c+"px; background:"+UIL.F0);this.scroller=UIL.DOM(null,"div",UIL.BASIC+"right:5px;  width:10px; pointer-events:none; background:#666; display:none;");this.c[2].name="list";this.c[3].name="title";this.c[3].style.color=this.fontColor;this.c[2].events="mousedown mousemove mouseup mousewheel mouseout mouseover".split(" ");this.c[3].events=["mousedown",
"mouseover","mouseout"];this.list=a.list||[];this.baseH=this.h;this.isShow=!1;this.itemHeight=a.itemHeight||this.h-3;this.full=a.full||!1;this.py=0;this.w=this.sb;this.isDown=this.scroll=!1;this.side=a.side||"down";this.holdTop=0;"up"===this.side?(this.c[2].style.top="auto",this.c[3].style.top="auto",this.c[4].style.top="auto",this.c[2].style.bottom=this.h-2+"px",this.c[3].style.bottom="1px",this.c[4].style.bottom=c+"px"):this.c[2].style.top=this.h-2+"px";this.listIn=UIL.DOM(null,"div",UIL.BASIC+
"left:0; top:0; width:100%; background:rgba(0,0,0,0.2);");this.listIn.name="list";this.c[2].appendChild(this.listIn);this.c[2].appendChild(this.scroller);this.setList(this.list,a.value);this.init()};UIL.List.prototype=Object.create(UIL.Proto.prototype);UIL.List.prototype.constructor=UIL.List;UIL.List.prototype.clearList=function(){for(;this.listIn.children.length;)this.listIn.removeChild(this.listIn.lastChild)};
