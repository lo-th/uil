...
fill:"#666"},this.scroll);this.content.appendChild(this.scroll);this.changeWidth();this.down=!1;this.f=[];this.f[0]=function(a){a.target.name&&"move"==a.target.name&&(this.down=!0,this.f[1](a),UIL.setSVG(this.scroll,"fill","#FFF"),UIL.setSVG(this.scroll,"fill","#FFF",1),UIL.setSVG(this.scroll,"fill","#FFF",2),a.preventDefault())}.bind(this);this.f[1]=function(a){if(this.down){var b=this.content.getBoundingClientRect();a=a.clientY-b.top-0.5*this.zone;0>a&&(a=0);a>this.zone&&(a=this.zone);this.py=a/
this.zone*this.range;this.f[5]()}}.bind(this);this.f[2]=function(a){this.down=!1;UIL.setSVG(this.scroll,"fill","#666");UIL.setSVG(this.scroll,"fill","#666",1);UIL.setSVG(this.scroll,"fill","#666",2)}.bind(this);this.f[3]=function(a){UIL.setSVG(this.scroll,"fill","#AAA");UIL.setSVG(this.scroll,"fill","#AAA",1);UIL.setSVG(this.scroll,"fill","#AAA",2)}.bind(this);this.f[4]=function(a){if(!this.lockwheel){var b=0;a.wheelDeltaY?b=0.04*-a.wheelDeltaY:a.wheelDelta?b=0.2*-a.wheelDelta:a.detail&&(b=4*a.detail);
this.py+=b;0>this.py&&(this.py=0);this.py>this.range&&(this.py=this.range);this.f[5]()}}.bind(this);this.f[5]=function(a){void 0!==a&&(this.py=a);this.inner.style.top=-this.py+"px";a=this.py*(this.height-this.sh)/this.range||0;UIL.setSVG(this.scroll,"y",a);UIL.setSVG(this.scroll,"y",a,1);0==this.py?UIL.setSVG(this.scroll,"y",0,2):this.py==this.max?UIL.setSVG(this.scroll,"y",this.height-1,2):UIL.setSVG(this.scroll,"y",-1,2)}.bind(this);this.content.onmousedown=this.f[0];this.content.onmousemove=this.f[1];
this.content.onmouseout=this.f[2];this.content.onmouseup=this.f[2];this.content.onmouseover=this.f[3];window.addEventListener("resize",function(a){this.resize(a)}.bind(this),!1);this.resize()};
...
UIL.String.prototype.rSize=function(){UIL.Proto.prototype.rSize.call(this);this.setDom(2,"width",this.sb);this.setDom(2,"left",this.sa)};UIL.Number=function(a){UIL.Proto.call(this,a);this.setTypeNumber(a);this.value=[0];this.toRad=1;this.isNumber=!0;this.isVector=this.isAngle=!1;this.mask=this.solo?null:UIL.main.mask;a.value&&(isNaN(a.value)?a.value instanceof Array?(this.value=a.value,this.isNumber=!1):a.value instanceof Object&&(this.value=[],a.value.x&&(this.value[0]=a.value.x),a.value.y&&(this.value[1]=a.value.y),a.value.z&&(this.value[2]=a.value.z),a.value.w&&(this.value[3]=a.value.w),this.isVector=!0):this.value=[a.value]);this.length=
