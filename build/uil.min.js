...
a},setSize:function(a){this.autoWidth&&(this.size=a||UIL.WIDTH,this.simple?(this.sa=1,this.sb=a-2):(this.sa=~~(this.size/3),this.sb=~~(2*this.sa-10)))},dispose:function(){this.clearEvent();UIL.clear(this.c[0]);null!==this.target?this.target.removeChild(this.c[0]):UIL.main.inner.removeChild(this.c[0]);this.target=this.callback=this.c=null},clear:function(){this.dispose()},setTypeNumber:function(a){this.value=0;void 0!==a.value&&(this.value="string"===typeof a.value?1*a.value:a.value);this.min=void 0===
a.min?-Infinity:a.min;this.max=void 0===a.max?Infinity:a.max;this.precision=void 0===a.precision?2:a.precision;var b;switch(this.precision){case 0:b=1;break;case 1:b=0.1;break;case 2:b=0.01;break;case 3:b=0.001;break;case 4:b=1E-4}this.step=void 0===a.step?b:a.step;this.range=this.max-this.min},numValue:function(a){return 1*Math.min(this.max,Math.max(this.min,a)).toFixed(this.precision)},rSize:function(){this.autoWidth&&(this.c[0].style.width=this.size+"px",this.simple||(this.c[1].style.width=this.sa+
...
UIL.List.prototype.rSize=function(){UIL.setSvg(this.c[6],"x",this.sb-15);UIL.Proto.prototype.rSize.call(this);this.c[2].style.width=this.sb+"px";this.c[2].style.left=this.sa-20+"px";this.c[3].style.width=this.sb+"px";this.c[3].style.left=this.sa+"px";this.c[4].style.left=this.sa+this.sb-17+"px";this.c[5].style.width=this.sb+"px";this.c[5].style.left=this.sa+"px";this.c[6].style.width=this.sb+"px";this.c[6].style.left=this.sa+"px";this.w=this.sb;this.max>this.maxHeight&&(this.w=this.sb-20);this.show&&
this.rSizeContent()};UIL.Bool=function(a){UIL.Proto.call(this,a);this.value=a.value||!1;this.c[2]=UIL.DOM("UIL svgbox","rect","width:17px;",{width:17,height:17,fill:UIL.SVGB,"stroke-width":1,stroke:UIL.SVGC});this.c[3]=UIL.DOM("UIL svgbox","path","width:17px; pointer-events:none;",{width:17,height:17,d:"M 4 9 L 6 12 14 4","stroke-width":2,stroke:this.fontColor,fill:"none","stroke-linecap":"butt"});this.value||(this.c[3].style.display="none");this.c[2].events=["click"];this.init()};UIL.Bool.prototype=Object.create(UIL.Proto.prototype);
...
this.value,this.oldr=this.r)};UIL.Circular.prototype.makePath=function(){var a=this.radius,b=this.percent*this.twoPi-0.001,c=a+a*Math.sin(0),d=a-a*Math.cos(0),e=a+a*Math.sin(b),f=a-a*Math.cos(b);return"M "+a+","+a+" L "+c+","+d+" A "+a+","+a+" 0 "+(b-0>Math.PI?1:0)+" 1 "+e+","+f+" Z"};UIL.Circular.prototype.update=function(a){this.c[2].textContent=this.value;this.percent=(this.value-this.min)/this.range;UIL.setSvg(this.c[4],"d",this.makePath());a&&this.callback(this.value)};UIL.Knob=function(a){UIL.Proto.call(this,a);this.autoWidth=!1;this.setTypeNumber(a);this.mPI=0.8*Math.PI;this.toDeg=180/Math.PI;this.cirRange=2*this.mPI;this.radius=a.radius||15;this.size=2*this.radius+20;void 0!==a.size&&(this.size=a.size,this.radius=0.5*~~(this.size-20));this.w=2*this.radius;this.height=2*this.radius;this.h=a.height||this.height+40;this.top=0;this.c[0].style.width=this.size+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.size+"px",this.c[1].style.textAlign="center",this.top=
