...
"x"+this.value[0]+" y"+this.value[1];UIL.setSvg(this.c[3],"cx",d);UIL.setSvg(this.c[3],"cy",e);UIL.setSvg(this.c[4],"cx",b);UIL.setSvg(this.c[4],"cy",c);this.oldx=this.x;this.oldy=this.y;a&&this.send();null!==this.interval&&0===this.x&&0===this.y&&(clearInterval(this.interval),this.interval=null)};UIL.Fps=function(a){UIL.Proto.call(this,a);this.autoHeight=!0;this.baseH=this.h;this.hplus=50;this.c[1].textContent="FPS";this.c[0].style.cursor="pointer";this.c[0].style.pointerEvents="auto";var b="display:none; left:10px; top:"+this.h+"px; height:"+(this.hplus-8)+"px; ";this.c[2]=UIL.DOM(null,"div",UIL.BASIC+b+"border:1px solid rgba(255, 255, 255, 0.2);");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+b+"border:1px solid rgba(255, 255, 255, 0);");this.c[4]=UIL.DOM(null,"div",UIL.BASIC+b+"border:1px solid rgba(255, 255, 255, 0);");
this.c[5]=UIL.DOM(null,"div",UIL.BASIC+"width:100%; bottom:0px; height:1px; background: rgba(255, 255, 255, 0.2);");this.isShow=a.show||!1;this.now=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now;this.prevTime=this.startTime=this.now();this.frames=0;this.isMem=!1;this.mm=this.mem=this.fps=this.ms=0;this.nFrame=40;self.performance&&self.performance.memory&&(this.isMem=!0);this.initGraph(1);this.c[0].events=["click","mousedown","mouseover","mouseout"];this.init()};
UIL.Fps.prototype=Object.create(UIL.Proto.prototype);UIL.Fps.prototype.constructor=UIL.Fps;UIL.Fps.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "click":this.click(a);break;case "mouseover":this.mode(1);break;case "mousedown":this.mode(2);break;case "mouseout":this.mode(0)}};UIL.Fps.prototype.click=function(a){this.isShow?this.hide():this.show()};
