...
UIL.Slide.prototype.blur=function(a){a.target.style.border="none";this.isEdit=a.target.contentEditable=!1};UIL.Slide.prototype.focus=function(a){a.target.style.border="1px dashed "+UIL.BorderSelect};UIL.List=function(a){UIL.Proto.call(this,a);this.autoHeight=!0;var b=a.align||"center";this.buttonColor=UIL.BUTTON;var c=Math.floor(0.5*this.h)-5;this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"top:0; height:90px; cursor:s-resize; pointer-events:auto; display:none; overflow:hidden;");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"border:1px solid "+UIL.Border+"; top:1px; pointer-events:auto; cursor:pointer; background:"+this.buttonColor+"; height:"+(this.h-2)+"px;");this.c[4]=UIL.DOM(null,"div",UIL.BASIC+"position:absolute; width:10px; height:10px; left:"+
(this.sa+this.sb-5)+"px; top:"+c+"px; background:"+UIL.F0);this.c[5]=UIL.DOM(null,"div",UIL.TXT+"text-align:"+b+"; height:"+(this.h-4)+"px; line-height:"+(this.h-8)+"px;");this.scroller=UIL.DOM(null,"div",UIL.BASIC+"right:5px;  width:10px; pointer-events:none; background:#666; display:none;");this.c[2].name="list";this.c[3].name="title";this.c[5].style.color=this.fontColor;this.c[2].events="mousedown mousemove mouseup mousewheel mouseout mouseover".split(" ");this.c[3].events=["mousedown","mouseover",
"mouseout"];this.list=a.list||[];this.baseH=this.h;this.isShow=!1;this.maxItem=a.maxItem||5;this.itemHeight=a.itemHeight||this.h-3;this.length=this.list.length;this.full=a.full||!1;this.maxHeight=this.maxItem*(this.itemHeight+1);this.py=0;this.w=this.sb;this.isDown=this.scroll=!1;this.side=a.side||"down";this.holdTop=0;"up"===this.side?(this.c[2].style.top="auto",this.c[3].style.top="auto",this.c[4].style.top="auto",this.c[5].style.top="auto",this.c[2].style.bottom=this.h+"px",this.c[3].style.bottom=
"1px",this.c[4].style.bottom=c+"px",this.c[5].style.bottom="2px"):this.c[2].style.top=this.h+"px";this.listIn=UIL.DOM(null,"div",UIL.BASIC+"left:0; top:0; width:100%; background:rgba(0,0,0,0.2);");this.listIn.name="list";this.c[2].style.height=this.maxHeight+"px";this.c[2].appendChild(this.listIn);this.c[2].appendChild(this.scroller);this.setList(this.list,a.value);this.init()};UIL.List.prototype=Object.create(UIL.Proto.prototype);UIL.List.prototype.constructor=UIL.List;
UIL.List.prototype.clearList=function(){for(;this.listIn.children.length;)this.listIn.removeChild(this.listIn.lastChild)};
UIL.List.prototype.setList=function(a,b){this.clearList();this.list=a;this.length=this.list.length;this.full&&(this.maxItem=this.length);this.max=this.length*(this.itemHeight+1);this.ratio=this.maxHeight/this.max;this.sh=this.maxHeight*this.ratio;this.range=this.maxHeight-this.sh;this.scroller.style.height=this.sh+"px";this.max>this.maxHeight&&(this.w=this.sb-20,this.scroll=!0);for(var c,d,e=0;e<this.length;e++)d=this.list[e],c=UIL.DOM(null,"div",UIL.ITEM+"width:"+this.w+"px; height:"+this.itemHeight+
"px; line-height:"+(this.itemHeight-5)+"px;"),c.textContent=d,c.style.color=this.fontColor,c.name="item",this.listIn.appendChild(c);void 0!==b?isNaN(b)?this.value=b:this.value=this.list[b]:this.value=this.list[0];this.c[5].textContent=this.value};
...
UIL.List.prototype.rSize=function(){UIL.Proto.prototype.rSize.call(this);var a=this.s;a[2].width=this.sb+"px";a[2].left=this.sa+"px";a[3].width=this.sb+"px";a[3].left=this.sa+"px";a[4].left=this.sa+this.sb-17+"px";a[5].width=this.sb+"px";a[5].left=this.sa+"px";this.w=this.sb;this.max>this.maxHeight&&(this.w=this.sb-20);this.isShow&&this.rSizeContent()};UIL.Bool=function(a){UIL.Proto.call(this,a);this.value=a.value||!1;this.buttonColor=UIL.BUTTON;this.inh=a.inh||this.h;a=~~(0.5*this.h)-0.5*(this.inh-2);this.c[2]=UIL.DOM(null,"div",UIL.BASIC+"background:"+UIL.BOOLBG+"; height:"+(this.inh-2)+"px; width:36px; top:"+a+"px; border-radius:20px; pointer-events:auto; cursor:pointer; transition:0.1s ease-out;");this.c[3]=UIL.DOM(null,"div",UIL.BASIC+"opasity:0, background:"+UIL.BOOLBG+"; height:"+(this.inh-6)+"px; width:"+(this.inh-6)+"px; top:"+(a+2)+"px; border-radius:20px; ");
