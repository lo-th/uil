...
UIL.Knob.prototype.move=function(a){this.isDown&&(this.r=-Math.atan2(this.radius-(a.clientX-this.rect.left),this.radius-(a.clientY-this.rect.top)),this.r>this.mPI&&(this.r=this.mPI),this.r<-this.mPI&&(this.r=-this.mPI),null!==this.oldr&&(this.r=Math.abs(this.r-this.oldr)>Math.PI?this.oldr:this.r),this.value=this.numValue(1/this.cirRange*this.range*(this.r+this.mPI)+this.min),this.update(!0),this.oldr=this.r)};
