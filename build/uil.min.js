...
"text-align:center; top:"+(this.h-20)+"px; width:"+this.w+"px; color:"+this.fontColor);this.c[3]=this.getCircular();this.setSvg(this.c[3],"d",this.makePath(),1);this.setSvg(this.c[3],"stroke",this.fontColor,1);this.setSvg(this.c[3],"viewBox","0 0 "+this.w+" "+this.w);this.setCss(this.c[3],{width:this.w,height:this.w,left:0,top:this.top});this.init();this.update()}function v(a){h.call(this,a);this.ctype=a.ctype||"hex";this.wfixe=256<this.sb?256:this.sb;this.side=a.side||"down";this.up="down"===this.side?
0:1;this.baseH=this.h;this.offset=new m;this.decal=new m;this.p=new m;this.c[2]=this.dom("div",this.css.txt+"height:"+(this.h-4)+"px;border-radius:"+this.radius+"px; line-height:"+(this.h-8)+"px;");this.s[2]=this.c[2].style;this.up&&(this.s[2].top="auto",this.s[2].bottom="2px");this.c[3]=this.getColorRing();this.c[3].style.visibility="hidden";this.hsl=null;this.value="#ffffff";void 0!==a.value&&(a.value instanceof Array?this.value=g.rgbToHex(a.value):isNaN(a.value)?this.value=a.value:this.value=g.hexToHtml(a.value));
this.bcolor=null;this.fistDown=this.isDown=!1;this.tr=98;this.tsl=Math.sqrt(3)*this.tr;this.hue=0;this.d=256;this.setColor(this.value);this.init();void 0!==a.open&&this.open()}function w(a){h.call(this,a);this.round=Math.round;this.autoHeight=!0;this.baseH=this.h;this.hplus=a.hplus||50;this.res=a.res||40;this.l=1;this.precision=a.precision||0;this.custom=a.custom||!1;this.names=a.names||["FPS","MS"];var b=a.cc||["90,90,90","255,255,0"];this.adding=a.adding||!1;this.range=a.range||[165,100,100];this.alpha=
...
"vector-effect":"non-scaling-stroke"},this.c[2]);this.init()}function F(a){h.call(this,a);this.value=void 0!==a.value?a.value:[0,0,0];this.lng=this.value.length;this.precision=void 0!==a.precision?a.precision:2;this.multiplicator=a.multiplicator||1;this.neg=a.neg||!1;this.line=void 0!==a.line?a.line:!0;this.autoWidth=void 0!==a.autoWidth?a.autoWidth:!0;this.isDown=this.isNumber=!1;this.h=a.h||138;this.rh=this.h-10;this.top=0;this.c[0].style.width=this.w+"px";void 0!==this.c[1]&&(this.c[1].style.width=
...
b[1].marginLeft="10px";b[1].lineHeight=this.h-4;b[1].color=this.fontColor;b[1].fontWeight="bold";0!==this.radius&&(b[0].borderRadius=this.radius+"px");b[0].border=this.colors.groupBorder;this.init();void 0!==a.bg&&this.setBG(a.bg);void 0!==a.open&&this.open()}function y(a){h.call(this,a);this.autoWidth=!1;this.value=[0,0];this.joyType="analogique";this.model=void 0!==a.mode?a.mode:0;this.precision=a.precision||2;this.multiplicator=a.multiplicator||1;this.pos=new m;this.tmp=new m;this.interval=null;
...
{width:this.w,height:this.w,left:0,top:this.top});this.ratio=128/this.w;this.init();this.update(!1)}function z(a){h.call(this,a);this.autoWidth=!1;this.buttonColor=this.colors.button;this.setTypeNumber(a);this.mPI=.8*Math.PI;this.toDeg=180/Math.PI;this.cirRange=2*this.mPI;this.offset=new m;this.radius=.5*this.w;this.h=a.h||this.w+10;this.top=0;this.c[0].style.width=this.w+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.w+"px",this.c[1].style.textAlign="center",this.top=10,this.h+=10);this.cmode=
this.percent=0;this.c[2]=this.dom("div",this.css.txt+"text-align:center; top:"+(this.h-20)+"px; width:"+this.w+"px; color:"+this.fontColor);this.c[3]=this.getKnob();this.setSvg(this.c[3],"stroke",this.fontColor,1);this.setSvg(this.c[3],"stroke",this.fontColor,3);this.setSvg(this.c[3],"d",this.makeGrad(),3);this.setSvg(this.c[3],"viewBox","0 0 "+this.ww+" "+this.ww);this.setCss(this.c[3],{width:this.w,height:this.w,left:0,top:this.top});this.r=0;this.init();this.update()}function A(a){h.call(this,
...
function D(a){h.call(this,a);this.cmode=0;this.value=a.value||"";this.placeHolder=a.placeHolder||"";this.allway=a.allway||!1;this.isDown=!1;this.c[2]=this.dom("div",this.css.basic+" background:"+this.colors.select+"; top:4px; width:0px; height:"+(this.h-8)+"px;");this.c[3]=this.dom("div",this.css.txtselect+"height:"+(this.h-4)+"px; line-height:"+(this.h-8)+"px; background:"+this.colors.inputBg+"; borderColor:"+this.colors.inputBorder+"; border-radius:"+this.radius+"px;");this.c[3].textContent=this.value;
this.c[4]=this.dom("div",this.css.basic+"top:4px; height:"+(this.h-8)+"px; width:0px; background:"+this.fontColor+";");this.init()}function E(a){h.call(this,a);a=a.prefix||"";this.c[2]=this.dom("div",this.css.txt+"text-align:right; width:60px; line-height:"+(this.h-8)+"px; color:"+this.fontColor);31===this.h&&(this.s[0].height=this.h+"px",this.s[1].top="8px",this.c[2].style.top="8px");this.c[1].textContent=this.txt.substring(0,1).toUpperCase()+this.txt.substring(1).replace("-"," ");this.c[2].textContent=
a;this.init()}function G(a){h.call(this,a);this.values=a.values;"string"===typeof this.values&&(this.values=[this.values]);this.value=a.value||this.values[0];this.isDown=!1;this.buttonColor=a.bColor||this.colors.button;this.lng=this.values.length;this.tmp=[];this.stat=[];for(var b=0;b<this.lng;b++)a=!1,this.values[b]===this.value&&(a=!0),this.c[b+2]=this.dom("div",this.css.txt+"text-align:center; top:1px; background:"+(a?this.colors.select:this.buttonColor)+"; height:"+(this.h-2)+"px; border-radius:"+
this.radius+"px; line-height:"+(this.h-4)+"px;"),this.c[b+2].style.color=a?"#FFF":this.fontColor,this.c[b+2].innerHTML=this.values[b],this.stat[b]=a?3:1;this.init()}function H(a){a.simple=!0;a.isEmpty=!0;h.call(this,a);this.init()}function I(a){h.call(this,a);this.p=100;this.value=this.txt;this.status=1;this.graph=this.svgs[a.itype||"none"];this.c[2]=this.dom("path",this.css.basic+"position:absolute; width:14px; height:14px; left:5px; top:"+(Math.floor(.5*this.h)-7)+"px;",{d:this.graph,fill:this.fontColor,
stroke:"none"});this.s[1].marginLeft="20px";this.init()}function J(a){h.call(this,a);this.value=!1;this.values=a.values||[];"string"===typeof this.values&&(this.values=[this.values]);this.isDown=!1;this.bsizeonColor=a.bColor||this.colors.button;this.lng=this.values.length;this.tmp=[];this.stat=[];this.grid=[2,Math.round(.5*this.lng)];this.spaces=[10,3];this.bsize=[70,18];this.h=Math.round(.5*this.lng)*(this.bsize[1]+this.spaces[1])+this.spaces[1];this.c[1].textContent="";this.c[2]=this.dom("table",
this.css.basic+"width:100%; top:"+(this.spaces[1]-2)+"px; height:auto; border-collapse:separate; border: none; border-spacing: "+(this.spaces[0]-2)+"px "+(this.spaces[1]-2)+"px;");a=0;this.buttons=[];this.stat=[];this.tmpX=[];this.tmpY=[];for(var b=0;b<this.grid[1];b++){var c=this.c[2].insertRow();c.style.cssText="pointer-events:none;";for(var d=0;d<this.grid[0];d++){var e=c.insertCell();e.style.cssText="pointer-events:none;";if(this.values[a]){var f=document.createElement("div");f.style.cssText=
this.css.txt+"position:static; width:"+this.bsize[0]+"px; height:"+this.bsize[1]+"px; text-align:center;  left:auto; right:auto; background:"+this.bsizeonColor+";  border-radius:"+this.radius+"px; line-height:"+(this.bsize[1]-4)+"px;";f.innerHTML=this.values[a];e.appendChild(f);this.buttons.push(f);this.stat.push(1)}else f=document.createElement("div"),f.style.cssText=this.css.txt+"position:static; width:"+this.bsize[0]+"px; height:"+this.bsize[1]+"px; text-align:center;  left:auto; right:auto; background:none;",
e.appendChild(f);f.style.cssText=0===d?f.style.cssText+"float:right;":f.style.cssText+"float:left;";a++}}this.init()}function K(){var a=arguments,b=!1,c=null;if("string"===typeof a[0]){var d=a[0];var e=a[1]||{}}else"object"===typeof a[0]&&(b=!0,void 0===a[2]&&[].push.call(a,{}),d=a[2].type?a[2].type:"slide",e=a[2],e.name=a[1],e.value=a[0][a[1]]);d=d.toLowerCase();"group"===d&&(e.add=K);switch(d){case "bool":c=new t(e);break;case "button":c=new u(e);break;case "circular":c=new q(e);break;case "color":c=
new v(e);break;case "fps":c=new w(e);break;case "graph":c=new F(e);break;case "group":c=new x(e);break;case "joystick":c=new y(e);break;case "knob":c=new z(e);break;case "list":c=new A(e);break;case "numeric":case "number":c=new B(e);break;case "slide":c=new C(e);break;case "textInput":case "string":c=new D(e);break;case "title":c=new E(e);break;case "selector":c=new G(e);break;case "empty":case "space":c=new H(e);break;case "item":c=new I(e);break;case "grid":c=new J(e)}if(null!==c)return b&&c.setReferency(a[0],
a[1]),c}function L(a){this.canvas=null;a=a||{};this.colors=g.cloneColor();this.css=g.cloneCss();a.config&&this.setConfig(a.config);this.bg=a.bg||this.colors.background;void 0!==a.transparent&&(this.colors.background="none",this.colors.backgroundOver="none");this.isReset=!0;this.tmpAdd=null;this.tmpH=0;this.isCanvas=a.isCanvas||!1;this.isCanvasOnly=!1;this.cssGui=void 0!==a.css?a.css:"";this.callback=void 0===a.callback?null:a.callback;this.forceHeight=a.maxHeight||0;this.lockHeight=a.lockHeight||
!1;this.isItemMode=void 0!==a.itemMode?a.itemMode:!1;this.cn="";this.size=g.size;void 0!==a.p&&(this.size.p=a.p);void 0!==a.w&&(this.size.w=a.w);void 0!==a.h&&(this.size.h=a.h);void 0!==a.s&&(this.size.s=a.s);this.size.h=11>this.size.h?11:this.size.h;this.local=(new m).neg();this.zone={x:0,y:0,w:this.size.w,h:0};this.mouse=(new m).neg();this.h=0;this.prevY=-1;this.sw=0;this.bh=(this.isWithClose=void 0!==a.close?a.close:!0)?this.size.h:0;this.autoResize=void 0===a.autoResize?!0:a.autoResize;this.isCenter=
a.center||!1;this.isOpen=!0;this.isScroll=this.isDown=!1;this.uis=[];this.current=-1;this.target=null;this.decal=0;this.ratio=1;this.oy=0;this.isNewTarget=!1;this.content=g.dom("div",this.css.basic+" width:0px; height:auto; top:0px; "+this.cssGui);this.innerContent=g.dom("div",this.css.basic+"width:100%; top:0; left:0; height:auto; overflow:hidden;");this.content.appendChild(this.innerContent);this.inner=g.dom("div",this.css.basic+"width:100%; left:0; ");this.innerContent.appendChild(this.inner);
this.scrollBG=g.dom("div",this.css.basic+"right:0; top:0; width:"+(this.size.s-1)+"px; height:10px; display:none; background:"+this.bg+";");this.content.appendChild(this.scrollBG);this.scroll=g.dom("div",this.css.basic+"background:"+this.colors.scroll+"; right:2px; top:0; width:"+(this.size.s-4)+"px; height:10px;");this.scrollBG.appendChild(this.scroll);this.bottom=g.dom("div",this.css.txt+"width:100%; top:auto; bottom:0; left:0; border-bottom-right-radius:10px;  border-bottom-left-radius:10px; text-align:center; height:"+
