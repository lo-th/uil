...
UIL.Proto.prototype={constructor:UIL.Proto,init:function(){this.c[0].style.background=UIL.bgcolor(this.color);for(var a=0;a<this.c.length;a++)0==a?null!==this.target?this.target.appendChild(this.c[0]):UIL.main.inner.appendChild(this.c[0]):this.c[0].appendChild(this.c[a]);this.rSize()},setSize:function(a){this.size=a||UIL.WIDTH;this.simple?(this.sa=1,this.sb=a-2):(this.sa=1*(this.size/3).toFixed(0),this.sb=1*(2*this.sa-10).toFixed(0))},setDom:function(a,b,c){this.c[a].style[b]=c+"px"},setSvg:function(a,
...
null;this.f=null}this.callback&&(this.callback=null);this.value&&(this.value=null)},clearDOM:function(a){for(;a.children.length;){if(a.lastChild.children)for(;a.lastChild.children.length;)a.lastChild.removeChild(a.lastChild.lastChild);a.removeChild(a.lastChild)}},setTypeNumber:function(a){this.min=-Infinity;this.max=Infinity;this.precision=2;void 0!==a.precision&&(this.precision=a.precision);this.step=0.01;switch(this.precision){case 0:this.step=1;break;case 1:this.step=0.1;break;case 2:this.step=
0.01;break;case 3:this.step=0.001;break;case 4:this.step=1E-4}void 0!==a.min&&(this.min=a.min);void 0!==a.max&&(this.max=a.max);void 0!==a.step&&(this.step=a.step)},numValue:function(a){return 1*Math.min(this.max,Math.max(this.min,a)).toFixed(this.precision)},rSize:function(){this.c[0].style.width=this.size+"px";this.simple||(this.c[1].style.width=this.sa+"px")}};UIL.Group=function(a){UIL.Proto.call(this,a);this.h=25;this.isOpen=!1;this.c[2]=UIL.DOM("UIL","div","top:25px; overflow:hidden;");this.c[3]=UIL.DOM("UIL","path","position:absolute; width:16px; left:"+(this.sa+this.sb-17)+"px; top:4px; pointer-events:none;",{width:16,height:16,d:"M 6 4 L 10 8 6 12","stroke-width":2,stroke:"#e2e2e2",fill:"none","stroke-linecap":"butt"});this.setDom(0,"height",this.h);this.setDom(1,"height",this.h);this.setDom(1,"top",0);this.c[1].style.pointerEvents="auto";this.c[1].style.cursor=
...
this.c[6]=UIL.DOM("UIL svgbox","rect","top:20px; height:90; pointer-events:none;",{x:this.sb-15,y:0,width:10,height:16,fill:"#666","stroke-width":1,stroke:UIL.SVGC});this.list=a.list||[];a.value?isNaN(a.value)?this.value=a.value:this.value=this.list[a.value]:this.value=this.list[0];this.show=!1;this.length=this.list.length;this.max=18*this.length;this.w=this.sb;this.down=!1;this.range=this.max-90;this.py=0;this.scroll=!1;this.side=a.side||"down";this.full=a.full||!1;90<this.max&&(this.w=this.sb-20,
this.scroll=!0);this.listIn=UIL.DOM("UIL list-in");this.listIn.name="list";this.c[2].appendChild(this.listIn);for(var b,c=0;c<this.length;c++)b=this.list[c],a=UIL.DOM("UIL listItem","div","width:"+this.w+"px; height:18px;"),a.textContent=b,a.name=b,this.listIn.appendChild(a);this.c[5].textContent=this.value;this.c[2].name="list";this.f[0]=function(a){if(this.show)this.f[1]();else this.f[2]()}.bind(this);this.f[1]=function(a){this.show=!1;this.h=20;this.c[0].style.height=this.h+"px";this.c[2].style.display=
"none";this.setSvg(4,"d","M 6 4 L 10 8 6 12");UIL.main&&UIL.main.calc()}.bind(this);this.f[2]=function(a){this.f[8](0);this.show=!0;this.h=120;this.scroll||(this.h=30+this.max,this.c[6].style.display="none",this.c[2].onmousemove=null,this.c[2].onmousewheel=null);this.c[0].style.height=this.h+"px";this.c[2].style.display="block";this.setSvg(4,"d","M 12 6 L 8 10 4 6");UIL.main&&UIL.main.calc()}.bind(this);this.f[3]=function(a){var b=a.target.name;"list"!==b&&void 0!==b?(this.value=a.target.name,this.c[5].textContent=
this.value,this.callback(this.value),this.f[1]()):"list"==b&&this.scroll&&(this.down=!0,this.f[4](a),this.listIn.style.background="rgba(0,0,0,0.6)",this.setSvg(6,"fill","#AAA"),a.preventDefault())}.bind(this);this.f[4]=function(a){if(this.down){var b=this.c[2].getBoundingClientRect();a=a.clientY-b.top;30>a&&(a=30);100<a&&(a=100);this.py=((a-30)/70*this.range).toFixed(0);this.f[8]()}}.bind(this);this.f[5]=function(a){UIL.main&&(UIL.main.lockwheel=!1);this.f[6]();if(void 0==a.relatedTarget.name)this.f[1]()}.bind(this);
this.f[6]=function(a){this.down=!1;this.listIn.style.background="rgba(0,0,0,0.2)";this.setSvg(6,"fill","#666")}.bind(this);this.f[7]=function(a){if(this.scroll){UIL.main&&(UIL.main.lockwheel=!0);var b=0;a.wheelDeltaY?b=0.04*-a.wheelDeltaY:a.wheelDelta?b=0.2*-a.wheelDelta:a.detail&&(b=4*a.detail);this.py+=b;0>this.py&&(this.py=0);this.py>this.range&&(this.py=this.range);this.f[8]()}}.bind(this);this.f[8]=function(a){this.scroll&&(void 0!==a&&(this.py=a),this.listIn.style.top=-this.py+"px",this.setSvg(6,
"y",70*this.py/this.range+2))}.bind(this);this.f[9]=function(a){this.c[5].style.color="#FFF";this.setSvg(3,"fill",UIL.SELECT)}.bind(this);this.f[10]=function(a){this.c[5].style.color="#CCC";this.setSvg(3,"fill",UIL.bgcolor(UIL.COLOR))}.bind(this);this.f[11]=function(a){this.c[5].style.color="#CCC";this.setSvg(3,"fill",UIL.SELECTDOWN)}.bind(this);this.c[2].onmousedown=this.f[3];this.c[2].onmousemove=this.f[4];this.c[2].onmouseout=this.f[5];this.c[2].onmouseup=this.f[6];this.c[2].onmousewheel=this.f[7];
this.c[3].onclick=this.f[0];this.c[3].onmouseover=this.f[9];this.c[3].onmouseout=this.f[10];this.c[3].onmouseup=this.f[10];this.c[3].onmousedown=this.f[11];this.init()};UIL.List.prototype=Object.create(UIL.Proto.prototype);UIL.List.prototype.constructor=UIL.List;UIL.List.prototype.text=function(a){this.c[5].textContent=a};
