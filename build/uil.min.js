...
UIL.RGBtoHSL=function(a){var b=a[0],c=a[1];a=a[2];var d=Math.min(b,c,a),e=Math.max(b,c,a),k=e-d,f=0,g=0,d=(d+e)/2;0<d&&1>d&&(g=k/(0.5>d?2*d:2-2*d));0<k&&(e==b&&e!=c&&(f+=(c-a)/k),e==c&&e!=a&&(f+=2+(a-b)/k),e==a&&e!=b&&(f+=4+(b-c)/k),f/=6);return[f,g,d]};UIL.Slide=function(a){UIL.Proto.call(this,a);this.setTypeNumber(a);this.range=this.max-this.min;this.width=UIL.BW-40;this.w=this.width-8;this.h=a.height||20;this.h=11>this.h?11:this.h;this.old=this.value=a.value||0;this.isOver=this.isDown=!1;a=0.5*a.height-10;void 0!==this.c[1]&&(this.c[1].style.top=a+"px");this.c[2]=UIL.DOM("UIL text","div","top:"+a+"px; text-align:right; width:40px; padding:3px 5px; color:"+this.fontColor);this.c[3]=UIL.DOM("UIL svgbox","rect","width:"+this.width+"px; height:"+
...
this.value,this.oldr=this.r)};UIL.Circular.prototype.makePath=function(){var a=this.radius,b=this.percent*this.twoPi-0.001,c=a+a*Math.sin(0),d=a-a*Math.cos(0),e=a+a*Math.sin(b),k=a-a*Math.cos(b);return"M "+a+","+a+" L "+c+","+d+" A "+a+","+a+" 0 "+(b-0>Math.PI?1:0)+" 1 "+e+","+k+" Z"};UIL.Circular.prototype.update=function(a){this.c[2].textContent=this.value;this.percent=(this.value-this.min)/this.range;UIL.setSvg(this.c[4],"d",this.makePath());a&&this.callback(this.value)};UIL.Knob=function(a){UIL.Proto.call(this,a);this.autoWidth=!1;this.setTypeNumber(a);this.range=this.max-this.min;this.mPI=0.8*Math.PI;this.toDeg=180/Math.PI;this.cirRange=2*this.mPI;this.value=a.value||0;this.radius=a.radius||15;this.size=2*this.radius+20;void 0!==a.size&&(this.size=a.size,this.radius=0.5*~~(this.size-20));this.w=2*this.radius;this.height=2*this.radius;this.h=a.height||this.height+40;this.top=0;this.c[0].style.width=this.size+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.size+
