...
a},setSize:function(a){this.autoWidth&&(this.size=a||UIL.WIDTH,this.simple?(this.sa=1,this.sb=a-2):(this.sa=~~(this.size/3),this.sb=~~(2*this.sa-10)))},clear:function(){this.clearEvent();this.purge(this.c[0]);for(var a=this.c.length;a--;)0!==a&&void 0!==this.c[a]&&(this.clearDOM(this.c[a]),this.c[0].removeChild(this.c[a]),this.c[a]=null);this.c[0].innerHTML="";null!==this.target?this.target.removeChild(this.c[0]):UIL.main.inner.removeChild(this.c[0]);this.c=this.handleEvent=this.c[0]=null;this.callback&&
(this.callback=null);this.value&&(this.value=null);this.purge(this)},purge:function(a){var b=a.attributes,c,d;if(b)for(c=b.length-1;0<=c;c-=1)d=b[c].name,"function"===typeof a[d]&&(a[d]=null);if(b=a.childNodes)for(b=b.length,c=0;c<b;c+=1)this.purge(a.childNodes[c])},clearDOM:function(a){for(;a.lastChild;){if(a.lastChild.children)for(;a.lastChild.lastChild;)a.lastChild.removeChild(a.lastChild.lastChild);a.removeChild(a.lastChild)}},setTypeNumber:function(a){this.value=0;void 0!==a.value&&(this.value=
"string"===typeof a.value?1*a.value:a.value);this.min=void 0===a.min?-Infinity:a.min;this.max=void 0===a.max?Infinity:a.max;this.precision=void 0===a.precision?2:a.precision;var b;switch(this.precision){case 0:b=1;break;case 1:b=0.1;break;case 2:b=0.01;break;case 3:b=0.001;break;case 4:b=1E-4}this.step=void 0===a.step?b:a.step;this.range=this.max-this.min},numValue:function(a){return 1*Math.min(this.max,Math.max(this.min,a)).toFixed(this.precision)},rSize:function(){this.autoWidth&&(this.c[0].style.width=
...
UIL.RGBtoHSL=function(a){var b=a[0],c=a[1];a=a[2];var d=Math.min(b,c,a),e=Math.max(b,c,a),g=e-d,h=0,k=0,d=(d+e)/2;0<d&&1>d&&(k=g/(0.5>d?2*d:2-2*d));0<g&&(e==b&&e!=c&&(h+=(c-a)/g),e==c&&e!=a&&(h+=2+(a-b)/g),e==a&&e!=b&&(h+=4+(b-c)/g),h/=6);return[h,k,d]};UIL.Slide=function(a){UIL.Proto.call(this,a);this.setTypeNumber(a);this.width=UIL.BW-40;this.w=this.width-8;this.h=a.height||20;this.h=11>this.h?11:this.h;this.old=this.value;this.isOver=this.isDown=!1;a=0.5*a.height-10;void 0!==this.c[1]&&(this.c[1].style.top=a+"px");this.c[2]=UIL.DOM("UIL text","div","top:"+a+"px; text-align:right; width:40px; padding:3px 5px; color:"+this.fontColor);this.c[3]=UIL.DOM("UIL svgbox","rect","width:"+this.width+"px; height:"+(this.h-3)+"px; cursor:w-resize;",{width:"100%",
height:this.h-3,fill:UIL.SVGB,"stroke-width":1,stroke:UIL.SVGC});this.c[4]=UIL.DOM("UIL svgbox","rect","left:4px; top:4px; width:"+(this.width-8)+"px; height:"+(this.h-10)+"px; pointer-events:none;",{width:"100%",height:"100%",fill:this.fontColor});a=this.c[3];UIL.DOM(null,"defs",null,{},a);UIL.DOM(null,"pattern",null,{id:"sripe",x:0,y:0,width:10,height:10,patternUnits:"userSpaceOnUse"},a,1);UIL.DOM(null,"line",null,{x1:5,x2:0,y1:0,y2:10,stroke:UIL.SVGC,"stroke-width":1},a,[1,0]);UIL.DOM(null,"line",
null,{x1:10,x2:5,y1:0,y2:10,stroke:UIL.SVGC,"stroke-width":1},a,[1,0]);a.events=["mouseover","mousedown","mouseout"];this.init()};UIL.Slide.prototype=Object.create(UIL.Proto.prototype);UIL.Slide.prototype.constructor=UIL.Slide;UIL.Slide.prototype.handleEvent=function(a){a.preventDefault();a.stopPropagation();switch(a.type){case "mouseover":this.over(a);break;case "mousedown":this.down(a);break;case "mouseout":this.out(a);break;case "mouseup":this.up(a);break;case "mousemove":this.move(a)}};
...
this.value,this.oldr=this.r)};UIL.Circular.prototype.makePath=function(){var a=this.radius,b=this.percent*this.twoPi-0.001,c=a+a*Math.sin(0),d=a-a*Math.cos(0),e=a+a*Math.sin(b),g=a-a*Math.cos(b);return"M "+a+","+a+" L "+c+","+d+" A "+a+","+a+" 0 "+(b-0>Math.PI?1:0)+" 1 "+e+","+g+" Z"};UIL.Circular.prototype.update=function(a){this.c[2].textContent=this.value;this.percent=(this.value-this.min)/this.range;UIL.setSvg(this.c[4],"d",this.makePath());a&&this.callback(this.value)};UIL.Knob=function(a){UIL.Proto.call(this,a);this.autoWidth=!1;this.setTypeNumber(a);this.mPI=0.8*Math.PI;this.toDeg=180/Math.PI;this.cirRange=2*this.mPI;this.radius=a.radius||15;this.size=2*this.radius+20;void 0!==a.size&&(this.size=a.size,this.radius=0.5*~~(this.size-20));this.w=2*this.radius;this.height=2*this.radius;this.h=a.height||this.height+40;this.top=0;this.c[0].style.width=this.size+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.size+"px",this.c[1].style.textAlign="center",this.top=
